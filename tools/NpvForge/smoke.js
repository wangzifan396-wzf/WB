...
const w=dom.window;
if(!w.NpvForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NpvForge')<0){ console.error('initial output missing'); process.exit(1); }
