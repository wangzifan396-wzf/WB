...
const w=dom.window;
if(!w.TimeCalcForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TimeCalcForge')<0){ console.error('initial output missing'); process.exit(1); }
