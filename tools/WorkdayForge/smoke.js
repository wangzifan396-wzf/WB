...
const w=dom.window;
if(!w.WorkdayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('工作日计算')<0){ console.error('initial output missing'); process.exit(1); }
