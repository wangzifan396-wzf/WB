...
const w=dom.window;
if(!w.KeyboardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KeyboardForge')<0){ console.error('initial output missing'); process.exit(1); }
