...
const w=dom.window;
if(!w.KaplanMeierForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('生存分析')<0){ console.error('initial output missing'); process.exit(1); }
