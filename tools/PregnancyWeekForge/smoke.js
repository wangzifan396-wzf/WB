...
const w=dom.window;
if(!w.PregnancyWeekForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PregnancyWeekForge')<0){ console.error('initial output missing'); process.exit(1); }
