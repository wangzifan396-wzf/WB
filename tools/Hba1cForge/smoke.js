...
const w=dom.window;
if(!w.Hba1cForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Hba1cForge')<0){ console.error('initial output missing'); process.exit(1); }
