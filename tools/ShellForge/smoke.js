...
const w=dom.window;
if(!w.__ShellForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('检查结果')<0){ console.error('initial output missing'); process.exit(1); }
