...
const w=dom.window;
if(!w.MarginForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('毛利率/加价率')<0){ console.error('initial output missing'); process.exit(1); }
