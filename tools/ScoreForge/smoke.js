...
const w=dom.window;
if(!w.ScoreForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('成绩统计')<0){ console.error('initial output missing'); process.exit(1); }
