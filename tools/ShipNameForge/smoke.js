...
const w=dom.window;
if(!w.ShipNameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ShipNameForge')<0){ console.error('initial output missing'); process.exit(1); }
