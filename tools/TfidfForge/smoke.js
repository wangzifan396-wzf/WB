...
const w=dom.window;
if(!w.TfidfForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TfidfForge')<0){ console.error('initial output missing'); process.exit(1); }
