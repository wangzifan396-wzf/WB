...
const w=dom.window;
if(!w.FenwickTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('树状数组')<0){ console.error('initial output missing'); process.exit(1); }
