...
const w=dom.window;
if(!w.CheckersForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('你的回合（红），点击棋子再点目标格')<0){ console.error('initial output missing'); process.exit(1); }
