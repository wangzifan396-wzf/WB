...
ok('A', A.italic('A').codePointAt(0)===0x1D434);
ok('a', A.italic('a').codePointAt(0)===0x1D44E);
ok('C special', A.italic('C')==='ℂ');
ok('digit passthrough', A.italic('1')==='1');
console.log('ItalicForge _test: '+pass+' passed, '+fail+' failed'); process.exit(fail?1:0);
