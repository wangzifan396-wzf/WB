...
const w=dom.window;
if(!w.TempoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TempoForge')<0){ console.error('initial output missing'); process.exit(1); }
