...
const w=dom.window;
if(!w.ApgarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ApgarForge')<0){ console.error('initial output missing'); process.exit(1); }
