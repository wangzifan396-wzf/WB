...
const w=dom.window;
if(!w.ConvexHullForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击“重新生成”计算凸包')<0){ console.error('initial output missing'); process.exit(1); }
