...
const w=dom.window;
if(!w.CapacitanceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电容计算')<0){ console.error('initial output missing'); process.exit(1); }
