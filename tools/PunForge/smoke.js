...
const w=dom.window;
if(!w.PunForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PunForge')<0){ console.error('initial output missing'); process.exit(1); }
