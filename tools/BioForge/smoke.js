...
const w=dom.window;
if(!w.BioForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BioForge')<0){ console.error('initial output missing'); process.exit(1); }
