...
const w=dom.window;
if(!w.VocabularyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('词汇卡片')<0){ console.error('initial output missing'); process.exit(1); }
