...
const w=dom.window;
if(!w.LogoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本 Logo')<0){ console.error('initial output missing'); process.exit(1); }
