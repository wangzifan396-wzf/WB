...
const w=dom.window;
if(!w.MaxFlowForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('最大流')<0){ console.error('initial output missing'); process.exit(1); }
