...
const w=dom.window;
if(!w.ReverbForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音频混响')<0){ console.error('initial output missing'); process.exit(1); }
