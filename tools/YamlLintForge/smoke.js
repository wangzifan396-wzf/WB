...
const w=dom.window;
if(!w.YamlLintForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('YAML校验')<0){ console.error('initial output missing'); process.exit(1); }
