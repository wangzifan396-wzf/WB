...
const w=dom.window;
if(!w.CaesarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('凯撒密码')<0){ console.error('initial output missing'); process.exit(1); }
