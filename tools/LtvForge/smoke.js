...
const w=dom.window;
if(!w.LtvForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LtvForge')<0){ console.error('initial output missing'); process.exit(1); }
