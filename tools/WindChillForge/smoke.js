...
const w=dom.window;
if(!w.WindChillForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('风寒指数')<0){ console.error('initial output missing'); process.exit(1); }
