...
const w=dom.window;
if(!w.MerkleTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('默克尔树')<0){ console.error('initial output missing'); process.exit(1); }
