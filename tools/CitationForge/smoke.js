...
const w=dom.window;
if(!w.CitationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文内引用')<0){ console.error('initial output missing'); process.exit(1); }
