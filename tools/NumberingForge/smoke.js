...
const w=dom.window;
if(!w.NumberingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('批量编号')<0){ console.error('initial output missing'); process.exit(1); }
