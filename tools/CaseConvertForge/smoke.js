...
const w=dom.window;
if(!w.CaseConvertForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('大小写转换')<0){ console.error('initial output missing'); process.exit(1); }
