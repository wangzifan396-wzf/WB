...
const w=dom.window;
if(!w.BudgetForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BudgetForge')<0){ console.error('initial output missing'); process.exit(1); }
