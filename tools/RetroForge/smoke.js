...
const w=dom.window;
if(!w.RetroForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RetroForge')<0){ console.error('initial output missing'); process.exit(1); }
