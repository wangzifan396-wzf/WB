...
const w=dom.window;
if(!w.SpacingScaleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SpacingScaleForge')<0){ console.error('initial output missing'); process.exit(1); }
