...
const w=dom.window;
if(!w.PlaceholderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PlaceholderForge')<0){ console.error('initial output missing'); process.exit(1); }
