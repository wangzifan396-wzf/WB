...
const w=dom.window;
if(!w.DensityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DensityForge')<0){ console.error('initial output missing'); process.exit(1); }
