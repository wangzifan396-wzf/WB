...
const w=dom.window;
if(!w.RetireForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RetireForge')<0){ console.error('initial output missing'); process.exit(1); }
