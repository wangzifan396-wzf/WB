...
const w=dom.window;
if(!w.LogisticRegForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('逻辑回归')<0){ console.error('initial output missing'); process.exit(1); }
