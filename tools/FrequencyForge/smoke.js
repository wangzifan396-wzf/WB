...
const w=dom.window;
if(!w.FrequencyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('频数表')<0){ console.error('initial output missing'); process.exit(1); }
