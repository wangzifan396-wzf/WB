...
const w=dom.window;
if(!w.ReadingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('阅读时间')<0){ console.error('initial output missing'); process.exit(1); }
