...
const w=dom.window;
if(!w.BodyMassForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('理想体重')<0){ console.error('initial output missing'); process.exit(1); }
