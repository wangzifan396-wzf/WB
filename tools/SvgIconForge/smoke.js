...
const w=dom.window;
if(!w.SvgIconForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SVG图标')<0){ console.error('initial output missing'); process.exit(1); }
