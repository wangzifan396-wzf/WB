...
const w=dom.window;
if(!w.WatermarkForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片文字水印')<0){ console.error('initial output missing'); process.exit(1); }
