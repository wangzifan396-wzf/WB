...
const w=dom.window;
if(!w.Bech32ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Bech32编解码')<0){ console.error('initial output missing'); process.exit(1); }
