...
const w=dom.window;
if(!w.ScreenRulerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('屏幕标尺')<0){ console.error('initial output missing'); process.exit(1); }
