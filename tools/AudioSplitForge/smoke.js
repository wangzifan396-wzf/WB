...
const w=dom.window;
if(!w.AudioSplitForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音频切片')<0){ console.error('initial output missing'); process.exit(1); }
