...
const w=dom.window;
if(!w.CollageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CollageForge')<0){ console.error('initial output missing'); process.exit(1); }
