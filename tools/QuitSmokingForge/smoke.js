...
const w=dom.window;
if(!w.QuitSmokingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('QuitSmokingForge')<0){ console.error('initial output missing'); process.exit(1); }
