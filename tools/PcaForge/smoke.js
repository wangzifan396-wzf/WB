...
const w=dom.window;
if(!w.PcaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PcaForge')<0){ console.error('initial output missing'); process.exit(1); }
