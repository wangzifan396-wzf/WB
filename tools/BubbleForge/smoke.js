...
const w=dom.window;
if(!w.BubbleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BubbleForge')<0){ console.error('initial output missing'); process.exit(1); }
