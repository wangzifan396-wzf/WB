...
const w=dom.window;
if(!w.TremoloForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TremoloForge')<0){ console.error('initial output missing'); process.exit(1); }
