...
const w=dom.window;
if(!w.__WordfreqForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WordfreqForge')<0){ console.error('initial output missing'); process.exit(1); }
