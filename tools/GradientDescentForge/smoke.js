...
const w=dom.window;
if(!w.GradientDescentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('梯度下降')<0){ console.error('initial output missing'); process.exit(1); }
