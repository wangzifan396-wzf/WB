...
const w=dom.window;
if(!w.JsonToCsvForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JSON转CSV')<0){ console.error('initial output missing'); process.exit(1); }
