...
const w=dom.window;
if(!w.InvestmentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('投资复利')<0){ console.error('initial output missing'); process.exit(1); }
