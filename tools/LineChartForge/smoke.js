...
const w=dom.window;
if(!w.LineChartForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LineChartForge')<0){ console.error('initial output missing'); process.exit(1); }
