...
const w=dom.window;
if(!w.FibonacciForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('斐波那契')<0){ console.error('initial output missing'); process.exit(1); }
