...
const w=dom.window;
if(!w.SubscriptionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SubscriptionForge')<0){ console.error('initial output missing'); process.exit(1); }
