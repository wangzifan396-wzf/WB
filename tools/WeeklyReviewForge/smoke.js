...
const w=dom.window;
if(!w.WeeklyReviewForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('周报复盘')<0){ console.error('initial output missing'); process.exit(1); }
