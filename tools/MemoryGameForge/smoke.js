...
const w=dom.window;
if(!w.MemoryGameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MemoryGameForge')<0){ console.error('initial output missing'); process.exit(1); }
