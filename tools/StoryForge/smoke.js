...
const w=dom.window;
if(!w.StoryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('故事梗概')<0){ console.error('initial output missing'); process.exit(1); }
