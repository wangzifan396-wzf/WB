...
const w=dom.window;
if(!w.AnagramForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('变位词查找')<0){ console.error('initial output missing'); process.exit(1); }
