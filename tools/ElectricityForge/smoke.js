...
const w=dom.window;
if(!w.ElectricityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ElectricityForge')<0){ console.error('initial output missing'); process.exit(1); }
