...
const w=dom.window;
if(!w.MancalaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击你那排（上半）任一有种子的坑')<0){ console.error('initial output missing'); process.exit(1); }
