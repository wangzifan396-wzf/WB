...
const w=dom.window;
if(!w.ReversiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('你的回合（黑）')<0){ console.error('initial output missing'); process.exit(1); }
