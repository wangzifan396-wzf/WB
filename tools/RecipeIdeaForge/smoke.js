...
const w=dom.window;
if(!w.RecipeIdeaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('菜谱灵感')<0){ console.error('initial output missing'); process.exit(1); }
