...
const w=dom.window;
if(!w.MoleculeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('分子量')<0){ console.error('initial output missing'); process.exit(1); }
