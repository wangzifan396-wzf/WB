...
const w=dom.window;
if(!w.LessonPlanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LessonPlanForge')<0){ console.error('initial output missing'); process.exit(1); }
