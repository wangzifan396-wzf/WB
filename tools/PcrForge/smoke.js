...
const w=dom.window;
if(!w.PcrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PCR 退火温度')<0){ console.error('initial output missing'); process.exit(1); }
