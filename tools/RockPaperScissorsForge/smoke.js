...
const w=dom.window;
if(!w.RockPaperScissorsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待出拳')<0){ console.error('initial output missing'); process.exit(1); }
