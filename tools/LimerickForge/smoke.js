...
const w=dom.window;
if(!w.LimerickForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('打油诗')<0){ console.error('initial output missing'); process.exit(1); }
