...
const w=dom.window;
if(!w.CombinationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('组合数')<0){ console.error('initial output missing'); process.exit(1); }
