...
const w=dom.window;
if(!w.BitcrushForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BitcrushForge')<0){ console.error('initial output missing'); process.exit(1); }
