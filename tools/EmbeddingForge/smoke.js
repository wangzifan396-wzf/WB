...
const w=dom.window;
if(!w.EmbeddingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('词向量')<0){ console.error('initial output missing'); process.exit(1); }
