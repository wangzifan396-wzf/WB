...
const w=dom.window;
if(!w.ClipboardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('剪贴板历史')<0){ console.error('initial output missing'); process.exit(1); }
