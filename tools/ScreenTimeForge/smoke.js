...
const w=dom.window;
if(!w.ScreenTimeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ScreenTimeForge')<0){ console.error('initial output missing'); process.exit(1); }
