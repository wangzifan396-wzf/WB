...
const w=dom.window;
if(!w.VectorDotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VectorDotForge')<0){ console.error('initial output missing'); process.exit(1); }
