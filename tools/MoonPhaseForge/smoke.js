...
const w=dom.window;
if(!w.MoonPhaseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MoonPhaseForge')<0){ console.error('initial output missing'); process.exit(1); }
