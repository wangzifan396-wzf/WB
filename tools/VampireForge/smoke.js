...
const w=dom.window;
if(!w.VampireForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VampireForge')<0){ console.error('initial output missing'); process.exit(1); }
