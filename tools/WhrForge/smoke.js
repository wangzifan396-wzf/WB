...
const w=dom.window;
if(!w.WhrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WhrForge')<0){ console.error('initial output missing'); process.exit(1); }
