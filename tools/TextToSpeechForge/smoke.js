...
const w=dom.window;
if(!w.TextToSpeechForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本转语音')<0){ console.error('initial output missing'); process.exit(1); }
