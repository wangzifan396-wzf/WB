...
const w=dom.window;
if(!w.ToneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音调发生器')<0){ console.error('initial output missing'); process.exit(1); }
