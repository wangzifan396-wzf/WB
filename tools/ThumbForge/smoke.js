...
const w=dom.window;
if(!w.ThumbForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片缩略图')<0){ console.error('initial output missing'); process.exit(1); }
