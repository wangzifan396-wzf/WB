...
const w=dom.window;
if(!w.BfsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('广度优先遍历')<0){ console.error('initial output missing'); process.exit(1); }
