...
const w=dom.window;
if(!w.SplineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('样条插值')<0){ console.error('initial output missing'); process.exit(1); }
