...
const w=dom.window;
if(!w.InductanceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电感')<0){ console.error('initial output missing'); process.exit(1); }
