...
const w=dom.window;
if(!w.RockPaperForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('石头剪刀布')<0){ console.error('initial output missing'); process.exit(1); }
