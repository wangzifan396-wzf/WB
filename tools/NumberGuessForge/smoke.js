...
const w=dom.window;
if(!w.NumberGuessForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('猜数字')<0){ console.error('initial output missing'); process.exit(1); }
