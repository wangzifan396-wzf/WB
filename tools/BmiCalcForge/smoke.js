...
const w=dom.window;
if(!w.BmiCalcForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BMI 计算')<0){ console.error('initial output missing'); process.exit(1); }
