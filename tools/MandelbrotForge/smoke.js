...
const w=dom.window;
if(!w.MandelbrotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('曼德博')<0){ console.error('initial output missing'); process.exit(1); }
