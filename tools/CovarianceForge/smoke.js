...
const w=dom.window;
if(!w.CovarianceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('协方差')<0){ console.error('initial output missing'); process.exit(1); }
