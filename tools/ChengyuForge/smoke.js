...
const w=dom.window;
if(!w.ChengyuForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChengyuForge')<0){ console.error('initial output missing'); process.exit(1); }
