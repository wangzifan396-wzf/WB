...
const w=dom.window;
if(!w.LocalModelSpecForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LocalModelSpecForge')<0){ console.error('initial output missing'); process.exit(1); }
