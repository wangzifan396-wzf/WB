...
const w=dom.window;
if(!w.PeriodicQuizForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PeriodicQuizForge')<0){ console.error('initial output missing'); process.exit(1); }
