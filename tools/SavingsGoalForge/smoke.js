...
const w=dom.window;
if(!w.SavingsGoalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SavingsGoalForge')<0){ console.error('initial output missing'); process.exit(1); }
