...
const w=dom.window;
if(!w.ChaosForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('混沌')<0){ console.error('initial output missing'); process.exit(1); }
