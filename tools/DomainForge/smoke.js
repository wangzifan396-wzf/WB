...
const w=dom.window;
if(!w.DomainForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('域名校验')<0){ console.error('initial output missing'); process.exit(1); }
