...
const w=dom.window;
if(!w.KLForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KLForge')<0){ console.error('initial output missing'); process.exit(1); }
