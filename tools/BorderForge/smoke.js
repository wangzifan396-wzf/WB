...
const w=dom.window;
if(!w.BorderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图像边框')<0){ console.error('initial output missing'); process.exit(1); }
