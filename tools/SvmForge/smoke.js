...
const w=dom.window;
if(!w.SvmForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SvmForge')<0){ console.error('initial output missing'); process.exit(1); }
