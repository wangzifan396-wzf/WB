...
const w=dom.window;
if(!w.HashTableForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('哈希与桶分布')<0){ console.error('initial output missing'); process.exit(1); }
