...
const w=dom.window;
if(!w.HappyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HappyForge')<0){ console.error('initial output missing'); process.exit(1); }
