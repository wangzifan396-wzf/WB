...
const w=dom.window;
if(!w.ChorusForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChorusForge')<0){ console.error('initial output missing'); process.exit(1); }
