...
const w=dom.window;
if(!w.RapForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RapForge')<0){ console.error('initial output missing'); process.exit(1); }
