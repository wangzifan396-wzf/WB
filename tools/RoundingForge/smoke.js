...
const w=dom.window;
if(!w.RoundingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('舍入模式')<0){ console.error('initial output missing'); process.exit(1); }
