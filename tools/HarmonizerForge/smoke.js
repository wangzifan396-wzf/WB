...
const w=dom.window;
if(!w.HarmonizerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HarmonizerForge')<0){ console.error('initial output missing'); process.exit(1); }
