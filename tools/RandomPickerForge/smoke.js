...
const w=dom.window;
if(!w.RandomPickerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('随机抽签器')<0){ console.error('initial output missing'); process.exit(1); }
