...
const w=dom.window;
if(!w.CosineSimForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CosineSimForge')<0){ console.error('initial output missing'); process.exit(1); }
