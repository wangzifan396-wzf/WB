...
const w=dom.window;
if(!w.BufferForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('缓冲液 pH')<0){ console.error('initial output missing'); process.exit(1); }
