...
const w=dom.window;
if(!w.RadiusForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('圆角生成')<0){ console.error('initial output missing'); process.exit(1); }
