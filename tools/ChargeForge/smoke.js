...
const w=dom.window;
if(!w.ChargeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电量换算')<0){ console.error('initial output missing'); process.exit(1); }
