...
const w=dom.window;
if(!w.SampleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('采样率与体积')<0){ console.error('initial output missing'); process.exit(1); }
