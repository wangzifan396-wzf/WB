...
const w=dom.window;
if(!w.KaleidoscopeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KaleidoscopeForge')<0){ console.error('initial output missing'); process.exit(1); }
