...
const w=dom.window;
if(!w.MealPlanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MealPlanForge')<0){ console.error('initial output missing'); process.exit(1); }
