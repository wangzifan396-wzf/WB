...
const w=dom.window;
if(!w.StoichiometryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StoichiometryForge')<0){ console.error('initial output missing'); process.exit(1); }
