...
const w=dom.window;
if(!w.ZerowidthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入秘密后点“隐藏”')<0){ console.error('initial output missing'); process.exit(1); }
