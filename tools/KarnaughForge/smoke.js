...
const w=dom.window;
if(!w.KarnaughForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('卡诺图化简')<0){ console.error('initial output missing'); process.exit(1); }
