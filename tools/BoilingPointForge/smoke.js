...
const w=dom.window;
if(!w.BoilingPointForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BoilingPointForge')<0){ console.error('initial output missing'); process.exit(1); }
