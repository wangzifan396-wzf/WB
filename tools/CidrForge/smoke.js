...
const w=dom.window;
if(!w.CidrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CIDR 计算')<0){ console.error('initial output missing'); process.exit(1); }
