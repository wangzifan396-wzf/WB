...
const w=dom.window;
if(!w.TimeboxForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('时间盒')<0){ console.error('initial output missing'); process.exit(1); }
