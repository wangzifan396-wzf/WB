...
const w=dom.window;
if(!w.BinauralForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('双耳节拍')<0){ console.error('initial output missing'); process.exit(1); }
