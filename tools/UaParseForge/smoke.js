...
const w=dom.window;
if(!w.UaParseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UaParseForge')<0){ console.error('initial output missing'); process.exit(1); }
