...
const w=dom.window;
if(!w.TrigForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('三角函数计算器')<0){ console.error('initial output missing'); process.exit(1); }
