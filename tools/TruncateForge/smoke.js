...
const w=dom.window;
if(!w.TruncateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本截断')<0){ console.error('initial output missing'); process.exit(1); }
