...
const w=dom.window;
if(!w.FontPreviewForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FontPreviewForge')<0){ console.error('initial output missing'); process.exit(1); }
