...
const w=dom.window;
if(!w.BibliographyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('参考文献')<0){ console.error('initial output missing'); process.exit(1); }
