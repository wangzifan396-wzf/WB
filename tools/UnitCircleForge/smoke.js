...
const w=dom.window;
if(!w.UnitCircleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UnitCircleForge')<0){ console.error('initial output missing'); process.exit(1); }
