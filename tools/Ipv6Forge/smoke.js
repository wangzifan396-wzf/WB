...
const w=dom.window;
if(!w.Ipv6ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('IPv6 地址转换')<0){ console.error('initial output missing'); process.exit(1); }
