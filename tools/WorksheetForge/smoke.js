...
const w=dom.window;
if(!w.WorksheetForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WorksheetForge')<0){ console.error('initial output missing'); process.exit(1); }
