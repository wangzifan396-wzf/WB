...
const w=dom.window;
if(!w.RedBlackTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('红黑树')<0){ console.error('initial output missing'); process.exit(1); }
