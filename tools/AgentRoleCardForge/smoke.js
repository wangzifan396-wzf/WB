...
const w=dom.window;
if(!w.AgentRoleCardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AgentRoleCardForge')<0){ console.error('initial output missing'); process.exit(1); }
