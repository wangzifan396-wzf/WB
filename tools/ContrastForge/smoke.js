...
const w=dom.window;
if(!w.ContrastForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WCAG对比度')<0){ console.error('initial output missing'); process.exit(1); }
