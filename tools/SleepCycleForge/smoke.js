...
const w=dom.window;
if(!w.SleepCycleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('睡眠周期')<0){ console.error('initial output missing'); process.exit(1); }
