...
const w=dom.window;
if(!w.MacroForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MacroForge')<0){ console.error('initial output missing'); process.exit(1); }
