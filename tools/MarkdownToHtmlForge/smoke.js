...
const w=dom.window;
if(!w.MarkdownToHtmlForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Markdown 转 HTML')<0){ console.error('initial output missing'); process.exit(1); }
