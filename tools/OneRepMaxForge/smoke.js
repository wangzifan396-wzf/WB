...
const w=dom.window;
if(!w.OneRepMaxForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('1RM 估算器')<0){ console.error('initial output missing'); process.exit(1); }
