...
const w=dom.window;
if(!w.SpellBeeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('拼写测验')<0){ console.error('initial output missing'); process.exit(1); }
