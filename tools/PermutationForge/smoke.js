...
const w=dom.window;
if(!w.PermutationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('排列数')<0){ console.error('initial output missing'); process.exit(1); }
