...
const w=dom.window;
if(!w.CircleOfFifthsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('五度圈')<0){ console.error('initial output missing'); process.exit(1); }
