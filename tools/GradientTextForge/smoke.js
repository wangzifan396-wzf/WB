...
const w=dom.window;
if(!w.GradientTextForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GradientTextForge')<0){ console.error('initial output missing'); process.exit(1); }
