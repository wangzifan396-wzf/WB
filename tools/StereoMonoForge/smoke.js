...
const w=dom.window;
if(!w.StereoMonoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('声道转换')<0){ console.error('initial output missing'); process.exit(1); }
