...
const w=dom.window;
if(!w.IpRangeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('IP 范围')<0){ console.error('initial output missing'); process.exit(1); }
