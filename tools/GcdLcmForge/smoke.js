...
const w=dom.window;
if(!w.GcdLcmForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('最大公约/最小公倍')<0){ console.error('initial output missing'); process.exit(1); }
