...
const w=dom.window;
if(!w.MeetingCostForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MeetingCostForge')<0){ console.error('initial output missing'); process.exit(1); }
