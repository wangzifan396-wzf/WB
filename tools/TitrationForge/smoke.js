...
const w=dom.window;
if(!w.TitrationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('强酸强碱滴定')<0){ console.error('initial output missing'); process.exit(1); }
