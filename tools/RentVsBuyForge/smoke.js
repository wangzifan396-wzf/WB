...
const w=dom.window;
if(!w.RentVsBuyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RentVsBuyForge')<0){ console.error('initial output missing'); process.exit(1); }
