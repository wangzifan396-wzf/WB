...
const w=dom.window;
if(!w.ABTestForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AB检验')<0){ console.error('initial output missing'); process.exit(1); }
