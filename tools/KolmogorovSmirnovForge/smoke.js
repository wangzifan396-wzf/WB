...
const w=dom.window;
if(!w.KolmogorovSmirnovForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KS检验')<0){ console.error('initial output missing'); process.exit(1); }
