...
const w=dom.window;
if(!w.__ErForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ErForge')<0){ console.error('initial output missing'); process.exit(1); }
