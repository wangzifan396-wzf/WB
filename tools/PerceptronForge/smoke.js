...
const w=dom.window;
if(!w.PerceptronForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PerceptronForge')<0){ console.error('initial output missing'); process.exit(1); }
