...
const w=dom.window;
if(!w.__YqForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('YqForge')<0){ console.error('initial output missing'); process.exit(1); }
