...
const w=dom.window;
if(!w.PayrollForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PayrollForge')<0){ console.error('initial output missing'); process.exit(1); }
