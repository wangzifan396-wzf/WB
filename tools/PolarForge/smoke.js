...
const w=dom.window;
if(!w.PolarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('极坐标转换')<0){ console.error('initial output missing'); process.exit(1); }
