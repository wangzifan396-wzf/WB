...
const w=dom.window;
if(!w.SeasonalDecomposeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('季节分解')<0){ console.error('initial output missing'); process.exit(1); }
