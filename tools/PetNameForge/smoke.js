...
const w=dom.window;
if(!w.PetNameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PetNameForge')<0){ console.error('initial output missing'); process.exit(1); }
