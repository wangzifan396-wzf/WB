...
const w=dom.window;
if(!w.WireframeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('线框骨架')<0){ console.error('initial output missing'); process.exit(1); }
