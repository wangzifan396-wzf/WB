...
const w=dom.window;
if(!w.BsaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BsaForge')<0){ console.error('initial output missing'); process.exit(1); }
