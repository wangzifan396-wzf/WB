...
const w=dom.window;
if(!w.FuelCostForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FuelCostForge')<0){ console.error('initial output missing'); process.exit(1); }
