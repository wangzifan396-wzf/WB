...
const w=dom.window;
if(!w.ExpectedValueForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ExpectedValueForge')<0){ console.error('initial output missing'); process.exit(1); }
