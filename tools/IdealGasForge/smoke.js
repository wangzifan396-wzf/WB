...
const w=dom.window;
if(!w.IdealGasForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('理想气体')<0){ console.error('initial output missing'); process.exit(1); }
