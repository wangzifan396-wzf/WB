...
const w=dom.window;
if(!w.ShikakuForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“新题目”生成一道四角分割谜题')<0){ console.error('initial output missing'); process.exit(1); }
