...
const w=dom.window;
if(!w.MockupForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('截图外框')<0){ console.error('initial output missing'); process.exit(1); }
