...
var ct=A.colEnc('WEAREDISCOVERED','ZEBRA');
ok('roundtrip', A.colDec(ct,'ZEBRA').replace(/X/g,'')==='WEAREDISCOVERED'.replace(/X/g,''));
console.log('ColumnarForge _test: '+pass+' passed, '+fail+' failed'); process.exit(fail?1:0);
