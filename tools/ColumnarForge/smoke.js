...
const w=dom.window;
if(!w.ColumnarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入明文与密钥后点“加密”')<0){ console.error('initial output missing'); process.exit(1); }
