...
const w=dom.window;
if(!w.AvatarTextForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文字头像')<0){ console.error('initial output missing'); process.exit(1); }
