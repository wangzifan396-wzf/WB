...
const w=dom.window;
if(!w.ChordFinderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('和弦组成')<0){ console.error('initial output missing'); process.exit(1); }
