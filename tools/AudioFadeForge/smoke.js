...
const w=dom.window;
if(!w.AudioFadeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('淡入淡出')<0){ console.error('initial output missing'); process.exit(1); }
