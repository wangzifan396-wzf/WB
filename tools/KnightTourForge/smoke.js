...
const w=dom.window;
if(!w.KnightTourForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('选择阶数后点“求解巡游”')<0){ console.error('initial output missing'); process.exit(1); }
