...
const w=dom.window;
if(!w.QLearningForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('QLearningForge')<0){ console.error('initial output missing'); process.exit(1); }
