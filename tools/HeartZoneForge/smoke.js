...
const w=dom.window;
if(!w.HeartZoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('心率训练区间')<0){ console.error('initial output missing'); process.exit(1); }
