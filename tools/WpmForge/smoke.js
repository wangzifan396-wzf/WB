...
const w=dom.window;
if(!w.WpmForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('打字测速')<0){ console.error('initial output missing'); process.exit(1); }
