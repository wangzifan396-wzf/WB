...
const w=dom.window;
if(!w.NewtonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('牛顿法')<0){ console.error('initial output missing'); process.exit(1); }
