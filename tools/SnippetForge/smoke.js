...
const w=dom.window;
if(!w.SnippetForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('代码片段')<0){ console.error('initial output missing'); process.exit(1); }
