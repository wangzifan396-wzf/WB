...
const w=dom.window;
if(!w.ReverseTextForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ReverseTextForge')<0){ console.error('initial output missing'); process.exit(1); }
