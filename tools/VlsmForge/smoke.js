...
const w=dom.window;
if(!w.VlsmForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VLSM 划分')<0){ console.error('initial output missing'); process.exit(1); }
