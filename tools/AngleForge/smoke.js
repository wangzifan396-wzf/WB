...
const w=dom.window;
if(!w.AngleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('角度换算')<0){ console.error('initial output missing'); process.exit(1); }
