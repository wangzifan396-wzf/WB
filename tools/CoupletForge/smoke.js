...
const w=dom.window;
if(!w.CoupletForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CoupletForge')<0){ console.error('initial output missing'); process.exit(1); }
