...
const w=dom.window;
if(!w.HeaderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HTTP 头')<0){ console.error('initial output missing'); process.exit(1); }
