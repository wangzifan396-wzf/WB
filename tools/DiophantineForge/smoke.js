...
const w=dom.window;
if(!w.DiophantineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('丢番图')<0){ console.error('initial output missing'); process.exit(1); }
