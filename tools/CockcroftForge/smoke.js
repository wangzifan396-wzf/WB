...
const w=dom.window;
if(!w.CockcroftForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CockcroftForge')<0){ console.error('initial output missing'); process.exit(1); }
