...
const w=dom.window;
if(!w.SmithWatermanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('局部序列比对')<0){ console.error('initial output missing'); process.exit(1); }
