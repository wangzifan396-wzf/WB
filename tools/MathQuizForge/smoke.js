...
const w=dom.window;
if(!w.MathQuizForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数学练习题')<0){ console.error('initial output missing'); process.exit(1); }
