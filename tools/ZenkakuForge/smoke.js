...
const w=dom.window;
if(!w.__ZenkakuForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ZenkakuForge')<0){ console.error('initial output missing'); process.exit(1); }
