...
const w=dom.window;
if(!w.PhotoelectricForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('光电效应')<0){ console.error('initial output missing'); process.exit(1); }
