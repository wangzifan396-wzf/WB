...
const w=dom.window;
if(!w.SunriseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SunriseForge')<0){ console.error('initial output missing'); process.exit(1); }
