...
const w=dom.window;
if(!w.WhacForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('看到地鼠就戳它！')<0){ console.error('initial output missing'); process.exit(1); }
