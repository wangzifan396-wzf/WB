...
const w=dom.window;
if(!w.TipForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('小费计算器')<0){ console.error('initial output missing'); process.exit(1); }
