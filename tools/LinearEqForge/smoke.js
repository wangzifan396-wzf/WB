...
const w=dom.window;
if(!w.LinearEqForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('线性方程')<0){ console.error('initial output missing'); process.exit(1); }
