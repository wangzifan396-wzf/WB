...
const w=dom.window;
if(!w.PeriodicTableForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PeriodicTableForge')<0){ console.error('initial output missing'); process.exit(1); }
