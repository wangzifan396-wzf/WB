...
const w=dom.window;
if(!w.TransformForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TransformForge')<0){ console.error('initial output missing'); process.exit(1); }
