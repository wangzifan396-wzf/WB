...
const w=dom.window;
if(!w.MermaidForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MermaidForge')<0){ console.error('initial output missing'); process.exit(1); }
