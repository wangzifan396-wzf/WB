...
const w=dom.window;
if(!w.ModuloForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('模运算')<0){ console.error('initial output missing'); process.exit(1); }
