...
const w=dom.window;
if(!w.LucasLehmerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('梅森素数')<0){ console.error('initial output missing'); process.exit(1); }
