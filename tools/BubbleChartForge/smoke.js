...
const w=dom.window;
if(!w.BubbleChartForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BubbleChartForge')<0){ console.error('initial output missing'); process.exit(1); }
