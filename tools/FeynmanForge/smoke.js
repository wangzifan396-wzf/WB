...
const w=dom.window;
if(!w.FeynmanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('费曼笔记')<0){ console.error('initial output missing'); process.exit(1); }
