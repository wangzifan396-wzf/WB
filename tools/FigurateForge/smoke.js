...
const w=dom.window;
if(!w.FigurateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('形数')<0){ console.error('initial output missing'); process.exit(1); }
