...
const w=dom.window;
if(!w.EulerianForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('欧拉回路')<0){ console.error('initial output missing'); process.exit(1); }
