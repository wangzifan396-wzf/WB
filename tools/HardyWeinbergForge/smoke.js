...
const w=dom.window;
if(!w.HardyWeinbergForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('哈迪-温伯格平衡')<0){ console.error('initial output missing'); process.exit(1); }
