...
const w=dom.window;
if(!w.HashIdentifierForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('哈希类型识别')<0){ console.error('initial output missing'); process.exit(1); }
