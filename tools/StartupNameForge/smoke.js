...
const w=dom.window;
if(!w.StartupNameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('产品名生成器')<0){ console.error('initial output missing'); process.exit(1); }
