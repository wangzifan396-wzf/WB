...
const w=dom.window;
if(!w.ConstForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('常数速查')<0){ console.error('initial output missing'); process.exit(1); }
