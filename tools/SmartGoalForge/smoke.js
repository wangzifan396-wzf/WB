...
const w=dom.window;
if(!w.SmartGoalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SMART 目标')<0){ console.error('initial output missing'); process.exit(1); }
