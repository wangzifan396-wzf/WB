...
const w=dom.window;
if(!w.__ReadabilityForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输出结果')<0){ console.error('initial output missing'); process.exit(1); }
