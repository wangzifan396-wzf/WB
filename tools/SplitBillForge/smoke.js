...
const w=dom.window;
if(!w.SplitBillForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AA分账计算器')<0){ console.error('initial output missing'); process.exit(1); }
