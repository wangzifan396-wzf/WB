...
const w=dom.window;
if(!w.__GitLogForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('统计报告')<0){ console.error('initial output missing'); process.exit(1); }
