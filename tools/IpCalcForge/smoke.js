...
const w=dom.window;
if(!w.IpCalcForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('子网计算')<0){ console.error('initial output missing'); process.exit(1); }
