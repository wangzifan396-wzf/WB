...
const w=dom.window;
if(!w.BodyFatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BodyFatForge')<0){ console.error('initial output missing'); process.exit(1); }
