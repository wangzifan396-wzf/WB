...
ok('A', A.mono('A').codePointAt(0)===0x1D670);
ok('a', A.mono('a').codePointAt(0)===0x1D68A);
ok('0', A.mono('0').codePointAt(0)===0x1D7F6);
console.log('MonoForge _test: '+pass+' passed, '+fail+' failed'); process.exit(fail?1:0);
