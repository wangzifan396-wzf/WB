...
const w=dom.window;
if(!w.ProbabilityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('概率与组合')<0){ console.error('initial output missing'); process.exit(1); }
