...
const w=dom.window;
if(!w.UlidForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UlidForge')<0){ console.error('initial output missing'); process.exit(1); }
