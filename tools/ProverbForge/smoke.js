...
const w=dom.window;
if(!w.ProverbForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('谚语解说')<0){ console.error('initial output missing'); process.exit(1); }
