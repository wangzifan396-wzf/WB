...
const w=dom.window;
if(!w.PostmortemForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PostmortemForge')<0){ console.error('initial output missing'); process.exit(1); }
