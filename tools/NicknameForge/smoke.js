...
const w=dom.window;
if(!w.NicknameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('昵称生成')<0){ console.error('initial output missing'); process.exit(1); }
