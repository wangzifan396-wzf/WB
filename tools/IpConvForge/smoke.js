...
const w=dom.window;
if(!w.IpConvForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('IPv4 进制转换')<0){ console.error('initial output missing'); process.exit(1); }
