...
const w=dom.window;
if(!w.PascalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('帕斯卡三角')<0){ console.error('initial output missing'); process.exit(1); }
