...
const w=dom.window;
if(!w.CsvSqlForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CSV转SQL')<0){ console.error('initial output missing'); process.exit(1); }
