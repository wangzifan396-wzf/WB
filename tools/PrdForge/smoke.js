...
const w=dom.window;
if(!w.PrdForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PrdForge')<0){ console.error('initial output missing'); process.exit(1); }
