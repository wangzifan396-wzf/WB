...
const w=dom.window;
if(!w.LogAnalyzerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LogAnalyzerForge')<0){ console.error('initial output missing'); process.exit(1); }
