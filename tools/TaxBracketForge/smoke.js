...
const w=dom.window;
if(!w.TaxBracketForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('累进个税')<0){ console.error('initial output missing'); process.exit(1); }
