...
const w=dom.window;
if(!w.PrimeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('质数与因式分解')<0){ console.error('initial output missing'); process.exit(1); }
