...
const w=dom.window;
if(!w.SvgShapeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SVG 图元生成')<0){ console.error('initial output missing'); process.exit(1); }
