...
const w=dom.window;
if(!w.PriorityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('优先级矩阵')<0){ console.error('initial output missing'); process.exit(1); }
