...
const w=dom.window;
if(!w.BandNameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('乐队名')<0){ console.error('initial output missing'); process.exit(1); }
