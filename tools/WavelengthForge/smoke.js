...
const w=dom.window;
if(!w.WavelengthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('波长/光子能量')<0){ console.error('initial output missing'); process.exit(1); }
