...
const w=dom.window;
if(!w.StepForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('步数换算')<0){ console.error('initial output missing'); process.exit(1); }
