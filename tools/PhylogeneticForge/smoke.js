...
const w=dom.window;
if(!w.PhylogeneticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('系统发育')<0){ console.error('initial output missing'); process.exit(1); }
