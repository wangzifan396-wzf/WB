...
const w=dom.window;
if(!w.PitchShiftForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('变调')<0){ console.error('initial output missing'); process.exit(1); }
