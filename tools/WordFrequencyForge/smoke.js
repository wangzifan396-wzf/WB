...
const w=dom.window;
if(!w.WordFrequencyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('词频统计')<0){ console.error('initial output missing'); process.exit(1); }
