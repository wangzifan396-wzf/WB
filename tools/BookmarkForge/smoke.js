...
const w=dom.window;
if(!w.BookmarkForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('链接管理')<0){ console.error('initial output missing'); process.exit(1); }
