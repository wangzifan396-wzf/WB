...
const w=dom.window;
if(!w.RandomColorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RandomColorForge')<0){ console.error('initial output missing'); process.exit(1); }
