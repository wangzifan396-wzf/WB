...
const w=dom.window;
if(!w.MastermindForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('已猜 0 次')<0){ console.error('initial output missing'); process.exit(1); }
