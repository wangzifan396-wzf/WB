...
const w=dom.window;
if(!w.XmlToJsonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('XML转JSON')<0){ console.error('initial output missing'); process.exit(1); }
