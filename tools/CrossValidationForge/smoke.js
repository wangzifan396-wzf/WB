...
const w=dom.window;
if(!w.CrossValidationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('交叉验证')<0){ console.error('initial output missing'); process.exit(1); }
