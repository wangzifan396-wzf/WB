...
const w=dom.window;
if(!w.MarketCapForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MarketCapForge')<0){ console.error('initial output missing'); process.exit(1); }
