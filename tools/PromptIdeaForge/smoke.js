...
const w=dom.window;
if(!w.PromptIdeaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('提示词灵感')<0){ console.error('initial output missing'); process.exit(1); }
