...
const w=dom.window;
if(!w.AreaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('二维图形面积')<0){ console.error('initial output missing'); process.exit(1); }
