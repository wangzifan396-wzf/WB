...
const w=dom.window;
if(!w.TowerOfHanoiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点柱子选源，再点目标柱子')<0){ console.error('initial output missing'); process.exit(1); }
