...
const w=dom.window;
if(!w.TooltipForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('提示气泡')<0){ console.error('initial output missing'); process.exit(1); }
