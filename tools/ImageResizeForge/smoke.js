...
const w=dom.window;
if(!w.ImageResizeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片缩放裁剪')<0){ console.error('initial output missing'); process.exit(1); }
