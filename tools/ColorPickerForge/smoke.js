...
const w=dom.window;
if(!w.ColorPickerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('取色器')<0){ console.error('initial output missing'); process.exit(1); }
