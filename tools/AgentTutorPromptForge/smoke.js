...
const w=dom.window;
if(!w.AgentTutorPromptForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AgentTutorPromptForge')<0){ console.error('initial output missing'); process.exit(1); }
