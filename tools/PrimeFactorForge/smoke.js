...
const w=dom.window;
if(!w.PrimeFactorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('质因数分解')<0){ console.error('initial output missing'); process.exit(1); }
