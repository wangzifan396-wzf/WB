...
const w=dom.window;
if(!w.MeltingPointForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MeltingPointForge')<0){ console.error('initial output missing'); process.exit(1); }
