...
const w=dom.window;
if(!w.NoteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音名频率')<0){ console.error('initial output missing'); process.exit(1); }
