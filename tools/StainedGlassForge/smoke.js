...
const w=dom.window;
if(!w.StainedGlassForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('预览')<0){ console.error('initial output missing'); process.exit(1); }
