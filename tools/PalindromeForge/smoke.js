...
const w=dom.window;
if(!w.PalindromeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待检测')<0){ console.error('initial output missing'); process.exit(1); }
