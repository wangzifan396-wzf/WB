...
const w=dom.window;
if(!w.GlossaryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GlossaryForge')<0){ console.error('initial output missing'); process.exit(1); }
