...
const w=dom.window;
if(!w.StickyNoteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('便利贴')<0){ console.error('initial output missing'); process.exit(1); }
