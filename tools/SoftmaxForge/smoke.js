...
const w=dom.window;
if(!w.SoftmaxForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('softmax采样')<0){ console.error('initial output missing'); process.exit(1); }
