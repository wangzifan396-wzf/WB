...
const w=dom.window;
if(!w.ProteinFoldForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('蛋白质折叠')<0){ console.error('initial output missing'); process.exit(1); }
