...
const w=dom.window;
if(!w.YamlToJsonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('YAML互转')<0){ console.error('initial output missing'); process.exit(1); }
