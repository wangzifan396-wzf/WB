...
const w=dom.window;
if(!w.PercentChangeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('百分比变化')<0){ console.error('initial output missing'); process.exit(1); }
