...
const w=dom.window;
if(!w.MergeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('双列合并')<0){ console.error('initial output missing'); process.exit(1); }
