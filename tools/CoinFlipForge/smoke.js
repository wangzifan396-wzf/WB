...
const w=dom.window;
if(!w.CoinFlipForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CoinFlipForge')<0){ console.error('initial output missing'); process.exit(1); }
