...
const w=dom.window;
if(!w.BatteryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('续航估算')<0){ console.error('initial output missing'); process.exit(1); }
