...
const w=dom.window;
if(!w.NaiveBayesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NaiveBayesForge')<0){ console.error('initial output missing'); process.exit(1); }
