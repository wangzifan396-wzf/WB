...
const w=dom.window;
if(!w.HistogramForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('颜色直方图')<0){ console.error('initial output missing'); process.exit(1); }
