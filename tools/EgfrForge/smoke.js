...
const w=dom.window;
if(!w.EgfrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EgfrForge')<0){ console.error('initial output missing'); process.exit(1); }
