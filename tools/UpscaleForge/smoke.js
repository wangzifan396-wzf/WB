...
const w=dom.window;
if(!w.UpscaleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UpscaleForge')<0){ console.error('initial output missing'); process.exit(1); }
