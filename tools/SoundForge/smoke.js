...
const w=dom.window;
if(!w.SoundForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('声速多普勒')<0){ console.error('initial output missing'); process.exit(1); }
