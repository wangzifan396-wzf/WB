...
const w=dom.window;
if(!w.MemoryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('配对进度 0 / 8')<0){ console.error('initial output missing'); process.exit(1); }
