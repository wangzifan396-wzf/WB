...
const w=dom.window;
if(!w.AminoAcidForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('氨基酸与肽链分子量')<0){ console.error('initial output missing'); process.exit(1); }
