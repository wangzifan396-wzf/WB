...
const w=dom.window;
if(!w.__NumfmtForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NumfmtForge')<0){ console.error('initial output missing'); process.exit(1); }
