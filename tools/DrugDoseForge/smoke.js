...
const w=dom.window;
if(!w.DrugDoseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DrugDoseForge')<0){ console.error('initial output missing'); process.exit(1); }
