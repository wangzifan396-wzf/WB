...
const w=dom.window;
if(!w.MetroForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('节拍器')<0){ console.error('initial output missing'); process.exit(1); }
