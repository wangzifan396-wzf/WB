...
const w=dom.window;
if(!w.IdenticonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('像素头像')<0){ console.error('initial output missing'); process.exit(1); }
