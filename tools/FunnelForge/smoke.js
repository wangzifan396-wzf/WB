...
const w=dom.window;
if(!w.FunnelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FunnelForge')<0){ console.error('initial output missing'); process.exit(1); }
