...
const w=dom.window;
if(!w.CompoundForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CompoundForge')<0){ console.error('initial output missing'); process.exit(1); }
