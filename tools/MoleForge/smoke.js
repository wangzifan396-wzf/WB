...
const w=dom.window;
if(!w.MoleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('摩尔质量')<0){ console.error('initial output missing'); process.exit(1); }
