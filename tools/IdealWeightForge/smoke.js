...
const w=dom.window;
if(!w.IdealWeightForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('IdealWeightForge')<0){ console.error('initial output missing'); process.exit(1); }
