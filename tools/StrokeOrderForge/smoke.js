...
const w=dom.window;
if(!w.StrokeOrderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StrokeOrderForge')<0){ console.error('initial output missing'); process.exit(1); }
