...
const w=dom.window;
if(!w.BodyTempForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BodyTempForge')<0){ console.error('initial output missing'); process.exit(1); }
