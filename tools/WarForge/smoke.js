...
const w=dom.window;
if(!w.WarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“出一轮”开始对战')<0){ console.error('initial output missing'); process.exit(1); }
