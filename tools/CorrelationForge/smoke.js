...
const w=dom.window;
if(!w.CorrelationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('皮尔逊相关')<0){ console.error('initial output missing'); process.exit(1); }
