...
const w=dom.window;
if(!w.SimonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击开始')<0){ console.error('initial output missing'); process.exit(1); }
