...
const w=dom.window;
if(!w.WordLadderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('词语接龙')<0){ console.error('initial output missing'); process.exit(1); }
