...
const w=dom.window;
if(!w.MaskForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“脱敏”在本地把敏感信息打码')<0){ console.error('initial output missing'); process.exit(1); }
