...
const w=dom.window;
if(!w.SeriesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数列求和')<0){ console.error('initial output missing'); process.exit(1); }
