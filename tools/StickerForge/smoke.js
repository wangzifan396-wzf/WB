...
const w=dom.window;
if(!w.StickerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StickerForge')<0){ console.error('initial output missing'); process.exit(1); }
