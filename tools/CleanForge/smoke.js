...
const w=dom.window;
if(!w.CleanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待清洗')<0){ console.error('initial output missing'); process.exit(1); }
