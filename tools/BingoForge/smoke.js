...
const w=dom.window;
if(!w.BingoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“喊下一个”开始')<0){ console.error('initial output missing'); process.exit(1); }
