...
const w=dom.window;
if(!w.SkeletonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('骨架屏')<0){ console.error('initial output missing'); process.exit(1); }
