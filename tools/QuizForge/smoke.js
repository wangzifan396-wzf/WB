...
const w=dom.window;
if(!w.QuizForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('选择题测验')<0){ console.error('initial output missing'); process.exit(1); }
