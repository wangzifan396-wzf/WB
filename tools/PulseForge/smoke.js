...
const w=dom.window;
if(!w.PulseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('目标心率')<0){ console.error('initial output missing'); process.exit(1); }
