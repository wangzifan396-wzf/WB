...
const w=dom.window;
if(!w.BiorhythmForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('生物节律')<0){ console.error('initial output missing'); process.exit(1); }
