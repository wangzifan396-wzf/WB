...
const w=dom.window;
if(!w.ChannelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChannelForge')<0){ console.error('initial output missing'); process.exit(1); }
