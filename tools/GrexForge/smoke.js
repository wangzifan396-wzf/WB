...
const w=dom.window;
if(!w.__GrexForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GrexForge')<0){ console.error('initial output missing'); process.exit(1); }
