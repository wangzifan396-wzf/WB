...
const w=dom.window;
if(!w.GrangerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('格兰杰因果')<0){ console.error('initial output missing'); process.exit(1); }
