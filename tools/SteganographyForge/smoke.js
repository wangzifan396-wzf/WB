...
const w=dom.window;
if(!w.SteganographyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本隐写')<0){ console.error('initial output missing'); process.exit(1); }
