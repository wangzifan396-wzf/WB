...
const w=dom.window;
if(!w.IntegralForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数值积分')<0){ console.error('initial output missing'); process.exit(1); }
