...
setTimeout(()=>{ const doc=window.document; let pass=0,fail=0;
  ...
  ok('AsciiForgePure exposed', typeof window.AsciiForgePure==='object');
  ok('run btn', !!doc.getElementById('run'));
  doc.getElementById('in').value='Hi'; doc.getElementById('run').click();
  ...
  console.log('AsciiForge smoke: '+pass+' passed, '+fail+' failed');
