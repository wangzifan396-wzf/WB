...
const w=dom.window;
if(!w.DataSizeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数据大小换算')<0){ console.error('initial output missing'); process.exit(1); }
