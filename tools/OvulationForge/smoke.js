...
const w=dom.window;
if(!w.OvulationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('OvulationForge')<0){ console.error('initial output missing'); process.exit(1); }
