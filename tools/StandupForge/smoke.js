...
const w=dom.window;
if(!w.StandupForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StandupForge')<0){ console.error('initial output missing'); process.exit(1); }
