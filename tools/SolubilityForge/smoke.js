...
const w=dom.window;
if(!w.SolubilityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('溶度积')<0){ console.error('initial output missing'); process.exit(1); }
