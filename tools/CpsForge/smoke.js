...
const w=dom.window;
if(!w.CpsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CpsForge')<0){ console.error('initial output missing'); process.exit(1); }
