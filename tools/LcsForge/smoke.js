...
const w=dom.window;
if(!w.LcsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('最长公共子序列')<0){ console.error('initial output missing'); process.exit(1); }
