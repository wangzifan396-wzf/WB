...
const w=dom.window;
if(!w.ExchangeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('货币换算')<0){ console.error('initial output missing'); process.exit(1); }
