...
const w=dom.window;
if(!w.RefractionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('折射临界角')<0){ console.error('initial output missing'); process.exit(1); }
