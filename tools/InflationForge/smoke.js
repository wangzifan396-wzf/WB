...
const w=dom.window;
if(!w.InflationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('InflationForge')<0){ console.error('initial output missing'); process.exit(1); }
