...
const w=dom.window;
if(!w.PythagoreanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('直角三角形')<0){ console.error('initial output missing'); process.exit(1); }
