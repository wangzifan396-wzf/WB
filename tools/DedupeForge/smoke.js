...
const w=dom.window;
if(!w.DedupeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('行去重')<0){ console.error('initial output missing'); process.exit(1); }
