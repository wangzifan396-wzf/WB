...
const w=dom.window;
if(!w.BugReportForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BugReportForge')<0){ console.error('initial output missing'); process.exit(1); }
