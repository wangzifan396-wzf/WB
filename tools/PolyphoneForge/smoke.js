...
const w=dom.window;
if(!w.PolyphoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PolyphoneForge')<0){ console.error('initial output missing'); process.exit(1); }
