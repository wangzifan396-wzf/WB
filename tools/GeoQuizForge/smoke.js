...
const w=dom.window;
if(!w.GeoQuizForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('地理测验')<0){ console.error('initial output missing'); process.exit(1); }
