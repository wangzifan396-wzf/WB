...
const w=dom.window;
if(!w.DedupForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DedupForge')<0){ console.error('initial output missing'); process.exit(1); }
