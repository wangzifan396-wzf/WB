...
const w=dom.window;
if(!w.Spo2ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Spo2Forge')<0){ console.error('initial output missing'); process.exit(1); }
