...
const w=dom.window;
if(!w.EmailValidateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('邮箱校验')<0){ console.error('initial output missing'); process.exit(1); }
