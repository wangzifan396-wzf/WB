...
const w=dom.window;
if(!w.CmykForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CmykForge')<0){ console.error('initial output missing'); process.exit(1); }
