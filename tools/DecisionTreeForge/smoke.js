...
const w=dom.window;
if(!w.DecisionTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DecisionTreeForge')<0){ console.error('initial output missing'); process.exit(1); }
