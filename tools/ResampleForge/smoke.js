...
const w=dom.window;
if(!w.ResampleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ResampleForge')<0){ console.error('initial output missing'); process.exit(1); }
