...
const w=dom.window;
if(!w.TokenizerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BPE分词')<0){ console.error('initial output missing'); process.exit(1); }
