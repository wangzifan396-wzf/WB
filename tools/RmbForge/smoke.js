...
const w=dom.window;
if(!w.RmbForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RmbForge')<0){ console.error('initial output missing'); process.exit(1); }
