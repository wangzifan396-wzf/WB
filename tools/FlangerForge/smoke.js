...
const w=dom.window;
if(!w.FlangerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FlangerForge')<0){ console.error('initial output missing'); process.exit(1); }
