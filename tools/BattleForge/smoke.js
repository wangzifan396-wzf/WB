...
const w=dom.window;
if(!w.BattleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('剩余战舰 5')<0){ console.error('initial output missing'); process.exit(1); }
