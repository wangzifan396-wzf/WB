...
const w=dom.window;
if(!w.JsonFixForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JSON 修复')<0){ console.error('initial output missing'); process.exit(1); }
