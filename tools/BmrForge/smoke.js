...
const w=dom.window;
if(!w.BmrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('基础代谢率')<0){ console.error('initial output missing'); process.exit(1); }
