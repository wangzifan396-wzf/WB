...
const w=dom.window;
if(!w.HookesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HookesForge')<0){ console.error('initial output missing'); process.exit(1); }
