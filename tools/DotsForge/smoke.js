...
const w=dom.window;
if(!w.DotsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('你的回合，点一条未连的线')<0){ console.error('initial output missing'); process.exit(1); }
