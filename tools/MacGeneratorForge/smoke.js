...
const w=dom.window;
if(!w.MacGeneratorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MAC 地址')<0){ console.error('initial output missing'); process.exit(1); }
