...
const w=dom.window;
if(!w.BoyleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('玻意耳定律')<0){ console.error('initial output missing'); process.exit(1); }
