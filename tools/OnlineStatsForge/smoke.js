...
const w=dom.window;
if(!w.OnlineStatsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('在线统计')<0){ console.error('initial output missing'); process.exit(1); }
