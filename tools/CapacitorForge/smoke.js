...
const w=dom.window;
if(!w.CapacitorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电容')<0){ console.error('initial output missing'); process.exit(1); }
