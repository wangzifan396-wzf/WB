...
const w=dom.window;
if(!w.WaterIntakeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WaterIntakeForge')<0){ console.error('initial output missing'); process.exit(1); }
