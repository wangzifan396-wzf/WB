...
const w=dom.window;
if(!w.ElementForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('元素速查')<0){ console.error('initial output missing'); process.exit(1); }
