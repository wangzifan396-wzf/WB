...
const w=dom.window;
if(!w.SleepTimeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SleepTimeForge')<0){ console.error('initial output missing'); process.exit(1); }
