...
const w=dom.window;
if(!w.GcdForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('最大公约数')<0){ console.error('initial output missing'); process.exit(1); }
