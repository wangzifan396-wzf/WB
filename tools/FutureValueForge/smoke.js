...
const w=dom.window;
if(!w.FutureValueForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('终值 FV')<0){ console.error('initial output missing'); process.exit(1); }
