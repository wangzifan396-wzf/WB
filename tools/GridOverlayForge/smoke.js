...
const w=dom.window;
if(!w.GridOverlayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GridOverlayForge')<0){ console.error('initial output missing'); process.exit(1); }
