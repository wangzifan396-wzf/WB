...
const w=dom.window;
if(!w.DerivativeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('多项式求导')<0){ console.error('initial output missing'); process.exit(1); }
