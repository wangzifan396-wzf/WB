...
const w=dom.window;
if(!w.RestrictionEnzymeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('限制性内切酶切点')<0){ console.error('initial output missing'); process.exit(1); }
