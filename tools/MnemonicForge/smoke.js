...
const w=dom.window;
if(!w.MnemonicForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('记忆法')<0){ console.error('initial output missing'); process.exit(1); }
