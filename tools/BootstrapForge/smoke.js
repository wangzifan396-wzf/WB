...
const w=dom.window;
if(!w.BootstrapForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('自助法')<0){ console.error('initial output missing'); process.exit(1); }
