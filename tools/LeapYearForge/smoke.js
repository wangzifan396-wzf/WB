...
const w=dom.window;
if(!w.LeapYearForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LeapYearForge')<0){ console.error('initial output missing'); process.exit(1); }
