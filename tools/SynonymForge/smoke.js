...
const w=dom.window;
if(!w.SynonymForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SynonymForge')<0){ console.error('initial output missing'); process.exit(1); }
