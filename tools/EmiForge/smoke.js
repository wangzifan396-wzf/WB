...
const w=dom.window;
if(!w.EmiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('贷款计算')<0){ console.error('initial output missing'); process.exit(1); }
