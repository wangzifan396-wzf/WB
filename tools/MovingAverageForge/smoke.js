...
const w=dom.window;
if(!w.MovingAverageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('移动平均')<0){ console.error('initial output missing'); process.exit(1); }
