...
const w=dom.window;
if(!w.ConjugateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('动词变位')<0){ console.error('initial output missing'); process.exit(1); }
