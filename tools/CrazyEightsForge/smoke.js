...
const w=dom.window;
if(!w.CrazyEightsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“开始”发牌，然后点一张合法的手牌出牌')<0){ console.error('initial output missing'); process.exit(1); }
