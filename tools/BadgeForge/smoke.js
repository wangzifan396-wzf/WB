...
const w=dom.window;
if(!w.BadgeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('徽章')<0){ console.error('initial output missing'); process.exit(1); }
