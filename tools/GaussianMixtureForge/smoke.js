...
const w=dom.window;
if(!w.GaussianMixtureForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('高斯混合')<0){ console.error('initial output missing'); process.exit(1); }
