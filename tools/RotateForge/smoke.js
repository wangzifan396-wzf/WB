...
const w=dom.window;
if(!w.RotateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图像旋转')<0){ console.error('initial output missing'); process.exit(1); }
