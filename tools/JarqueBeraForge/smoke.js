...
const w=dom.window;
if(!w.JarqueBeraForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JB正态性')<0){ console.error('initial output missing'); process.exit(1); }
