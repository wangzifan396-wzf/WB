...
const w=dom.window;
if(!w.SilenceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SilenceForge')<0){ console.error('initial output missing'); process.exit(1); }
