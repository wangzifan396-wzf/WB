...
const w=dom.window;
if(!w.YahtzeeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击骰子保留/取消，再掷；点记分格锁定分数')<0){ console.error('initial output missing'); process.exit(1); }
