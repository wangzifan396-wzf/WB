...
const w=dom.window;
if(!w.MnemonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数字助记')<0){ console.error('initial output missing'); process.exit(1); }
