...
const w=dom.window;
if(!w.RomanNumeralForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('罗马数字转换')<0){ console.error('initial output missing'); process.exit(1); }
