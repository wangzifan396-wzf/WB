...
const w=dom.window;
if(!w.SpecificHeatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('比热热量')<0){ console.error('initial output missing'); process.exit(1); }
