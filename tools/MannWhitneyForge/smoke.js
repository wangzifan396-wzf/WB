...
const w=dom.window;
if(!w.MannWhitneyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('曼惠特尼')<0){ console.error('initial output missing'); process.exit(1); }
