...
const w=dom.window;
if(!w.AudioReverseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音频反向')<0){ console.error('initial output missing'); process.exit(1); }
