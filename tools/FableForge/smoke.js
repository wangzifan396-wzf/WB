...
const w=dom.window;
if(!w.FableForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('寓言生成')<0){ console.error('initial output missing'); process.exit(1); }
