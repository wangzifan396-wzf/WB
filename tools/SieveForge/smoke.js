...
const w=dom.window;
if(!w.SieveForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('素数筛')<0){ console.error('initial output missing'); process.exit(1); }
