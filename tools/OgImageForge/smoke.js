...
const w=dom.window;
if(!w.OgImageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('OgImageForge')<0){ console.error('initial output missing'); process.exit(1); }
