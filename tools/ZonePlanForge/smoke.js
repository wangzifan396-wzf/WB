...
const w=dom.window;
if(!w.ZonePlanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ZonePlanForge')<0){ console.error('initial output missing'); process.exit(1); }
