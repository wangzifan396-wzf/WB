...
const w=dom.window;
if(!w.PieChartForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PieChartForge')<0){ console.error('initial output missing'); process.exit(1); }
