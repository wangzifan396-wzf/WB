...
const w=dom.window;
if(!w.RateCardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RateCardForge')<0){ console.error('initial output missing'); process.exit(1); }
