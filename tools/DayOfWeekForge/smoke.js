...
const w=dom.window;
if(!w.DayOfWeekForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DayOfWeekForge')<0){ console.error('initial output missing'); process.exit(1); }
