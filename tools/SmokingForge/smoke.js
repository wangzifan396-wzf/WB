...
const w=dom.window;
if(!w.SmokingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SmokingForge')<0){ console.error('initial output missing'); process.exit(1); }
