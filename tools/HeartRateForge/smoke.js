...
const w=dom.window;
if(!w.HeartRateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HeartRateForge')<0){ console.error('initial output missing'); process.exit(1); }
