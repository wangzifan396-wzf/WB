...
const w=dom.window;
if(!w.HeartRateZoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HeartRateZoneForge')<0){ console.error('initial output missing'); process.exit(1); }
