...
const w=dom.window;
if(!w.ModelCardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ModelCardForge')<0){ console.error('initial output missing'); process.exit(1); }
