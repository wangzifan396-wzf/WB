...
const w=dom.window;
if(!w.JokeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('冷笑话')<0){ console.error('initial output missing'); process.exit(1); }
