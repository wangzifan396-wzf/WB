...
const w=dom.window;
if(!w.ArithmeticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等差数列')<0){ console.error('initial output missing'); process.exit(1); }
