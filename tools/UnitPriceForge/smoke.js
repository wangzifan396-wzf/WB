...
const w=dom.window;
if(!w.UnitPriceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('单位比价')<0){ console.error('initial output missing'); process.exit(1); }
