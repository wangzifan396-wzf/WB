...
const w=dom.window;
if(!w.CodonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('密码子翻译')<0){ console.error('initial output missing'); process.exit(1); }
