...
const w=dom.window;
if(!w.AimForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AimForge')<0){ console.error('initial output missing'); process.exit(1); }
