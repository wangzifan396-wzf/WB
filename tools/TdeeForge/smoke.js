...
const w=dom.window;
if(!w.TdeeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TdeeForge')<0){ console.error('initial output missing'); process.exit(1); }
