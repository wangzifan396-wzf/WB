...
const w=dom.window;
if(!w.HydrationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('饮水量')<0){ console.error('initial output missing'); process.exit(1); }
