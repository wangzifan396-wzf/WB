...
const w=dom.window;
if(!w.TimezoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('时区转换')<0){ console.error('initial output missing'); process.exit(1); }
