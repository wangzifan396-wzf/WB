...
const w=dom.window;
if(!w.SkillSpecForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SkillSpecForge')<0){ console.error('initial output missing'); process.exit(1); }
