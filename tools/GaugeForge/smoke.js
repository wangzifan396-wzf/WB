...
const w=dom.window;
if(!w.GaugeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GaugeForge')<0){ console.error('initial output missing'); process.exit(1); }
