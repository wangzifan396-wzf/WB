...
const w=dom.window;
if(!w.RoiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RoiForge')<0){ console.error('initial output missing'); process.exit(1); }
