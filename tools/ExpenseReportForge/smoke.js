...
const w=dom.window;
if(!w.ExpenseReportForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ExpenseReportForge')<0){ console.error('initial output missing'); process.exit(1); }
