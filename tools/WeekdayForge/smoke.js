...
const w=dom.window;
if(!w.WeekdayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('日期信息')<0){ console.error('initial output missing'); process.exit(1); }
