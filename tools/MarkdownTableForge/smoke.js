...
const w=dom.window;
if(!w.MarkdownTableForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Markdown表格')<0){ console.error('initial output missing'); process.exit(1); }
