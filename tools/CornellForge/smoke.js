...
const w=dom.window;
if(!w.CornellForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('康奈尔笔记')<0){ console.error('initial output missing'); process.exit(1); }
