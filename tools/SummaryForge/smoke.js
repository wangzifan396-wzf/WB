...
const w=dom.window;
if(!w.SummaryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SummaryForge')<0){ console.error('initial output missing'); process.exit(1); }
