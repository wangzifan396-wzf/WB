...
const w=dom.window;
if(!w.DopplerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('多普勒效应计算器')<0){ console.error('initial output missing'); process.exit(1); }
