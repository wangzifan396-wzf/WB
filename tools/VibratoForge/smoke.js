...
const w=dom.window;
if(!w.VibratoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VibratoForge')<0){ console.error('initial output missing'); process.exit(1); }
