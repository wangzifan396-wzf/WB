...
const w=dom.window;
if(!w.FlipTextForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FlipTextForge')<0){ console.error('initial output missing'); process.exit(1); }
