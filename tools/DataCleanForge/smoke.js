...
const w=dom.window;
if(!w.DataCleanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数据清洗')<0){ console.error('initial output missing'); process.exit(1); }
