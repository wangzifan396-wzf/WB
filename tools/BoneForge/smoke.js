...
const w=dom.window;
if(!w.BoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BoneForge')<0){ console.error('initial output missing'); process.exit(1); }
