...
const w=dom.window;
if(!w.MeetingAgendaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MeetingAgendaForge')<0){ console.error('initial output missing'); process.exit(1); }
