...
const w=dom.window;
if(!w.IndentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('批量缩进')<0){ console.error('initial output missing'); process.exit(1); }
