...
const w=dom.window;
if(!w.PassphraseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PassphraseForge')<0){ console.error('initial output missing'); process.exit(1); }
