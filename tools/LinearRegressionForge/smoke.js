...
const w=dom.window;
if(!w.LinearRegressionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('线性回归')<0){ console.error('initial output missing'); process.exit(1); }
