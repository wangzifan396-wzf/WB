...
const w=dom.window;
if(!w.SpanningTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('最小生成树')<0){ console.error('initial output missing'); process.exit(1); }
