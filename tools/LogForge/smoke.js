...
const w=dom.window;
if(!w.LogForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('对数换底')<0){ console.error('initial output missing'); process.exit(1); }
