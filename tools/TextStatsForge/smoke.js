...
const w=dom.window;
if(!w.TextStatsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本统计')<0){ console.error('initial output missing'); process.exit(1); }
