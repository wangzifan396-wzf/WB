...
const w=dom.window;
if(!w.CodeReviewForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CodeReviewForge')<0){ console.error('initial output missing'); process.exit(1); }
