...
const w=dom.window;
if(!w.CoverLetterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('求职信生成')<0){ console.error('initial output missing'); process.exit(1); }
