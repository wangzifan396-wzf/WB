...
const w=dom.window;
if(!w.CircleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('圆的几何')<0){ console.error('initial output missing'); process.exit(1); }
