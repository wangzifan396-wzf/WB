...
const w=dom.window;
if(!w.FractionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('分数计算器')<0){ console.error('initial output missing'); process.exit(1); }
