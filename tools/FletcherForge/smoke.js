...
const w=dom.window;
if(!w.__FletcherForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FletcherForge')<0){ console.error('initial output missing'); process.exit(1); }
