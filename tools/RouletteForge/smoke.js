...
const w=dom.window;
if(!w.RouletteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('选择一种下注方式再旋转')<0){ console.error('initial output missing'); process.exit(1); }
