...
const w=dom.window;
if(!w.Vo2ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VO2max 估算')<0){ console.error('initial output missing'); process.exit(1); }
