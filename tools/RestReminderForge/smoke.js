...
const w=dom.window;
if(!w.RestReminderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RestReminderForge')<0){ console.error('initial output missing'); process.exit(1); }
