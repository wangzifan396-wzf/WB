...
const w=dom.window;
if(!w.HeatIndexForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HeatIndexForge')<0){ console.error('initial output missing'); process.exit(1); }
