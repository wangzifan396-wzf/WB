...
const w=dom.window;
if(!w.MacAddrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MacAddrForge')<0){ console.error('initial output missing'); process.exit(1); }
