...
const w=dom.window;
if(!w.MeetingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('会议纪要')<0){ console.error('initial output missing'); process.exit(1); }
