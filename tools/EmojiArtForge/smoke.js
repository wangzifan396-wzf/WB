...
const w=dom.window;
if(!w.EmojiArtForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击下方图案复制')<0){ console.error('initial output missing'); process.exit(1); }
