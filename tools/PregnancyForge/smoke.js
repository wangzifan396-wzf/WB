...
const w=dom.window;
if(!w.PregnancyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PregnancyForge')<0){ console.error('initial output missing'); process.exit(1); }
