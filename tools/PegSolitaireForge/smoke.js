...
const w=dom.window;
if(!w.PegSolitaireForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('剩余 32 子，目标是只剩 1 子')<0){ console.error('initial output missing'); process.exit(1); }
