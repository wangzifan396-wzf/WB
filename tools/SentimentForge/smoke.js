...
const w=dom.window;
if(!w.SentimentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SentimentForge')<0){ console.error('initial output missing'); process.exit(1); }
