...
const w=dom.window;
if(!w.RandomForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('随机数')<0){ console.error('initial output missing'); process.exit(1); }
