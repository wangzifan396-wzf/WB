...
const w=dom.window;
if(!w.FifteenForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('移动 0 步')<0){ console.error('initial output missing'); process.exit(1); }
