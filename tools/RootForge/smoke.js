...
const w=dom.window;
if(!w.RootForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('开方')<0){ console.error('initial output missing'); process.exit(1); }
