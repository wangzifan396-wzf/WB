...
const w=dom.window;
if(!w.ReynoldsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ReynoldsForge')<0){ console.error('initial output missing'); process.exit(1); }
