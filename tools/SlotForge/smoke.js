...
const w=dom.window;
if(!w.SlotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待旋转')<0){ console.error('initial output missing'); process.exit(1); }
