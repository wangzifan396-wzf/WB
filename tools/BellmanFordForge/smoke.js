...
const w=dom.window;
if(!w.BellmanFordForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('贝尔曼')<0){ console.error('initial output missing'); process.exit(1); }
