...
const w=dom.window;
if(!w.LightsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点亮数 0')<0){ console.error('initial output missing'); process.exit(1); }
