...
const w=dom.window;
if(!w.MillerRabinForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('素数判定')<0){ console.error('initial output missing'); process.exit(1); }
