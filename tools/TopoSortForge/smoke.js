...
const w=dom.window;
if(!w.TopoSortForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('拓扑排序')<0){ console.error('initial output missing'); process.exit(1); }
