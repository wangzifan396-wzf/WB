...
const w=dom.window;
if(!w.SalaryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('税后工资')<0){ console.error('initial output missing'); process.exit(1); }
