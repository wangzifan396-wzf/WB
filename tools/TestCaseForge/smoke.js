...
const w=dom.window;
if(!w.TestCaseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TestCaseForge')<0){ console.error('initial output missing'); process.exit(1); }
