...
const w=dom.window;
if(!w.HeatEngineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('卡诺热机')<0){ console.error('initial output missing'); process.exit(1); }
