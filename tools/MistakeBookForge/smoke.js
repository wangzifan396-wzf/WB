...
const w=dom.window;
if(!w.MistakeBookForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('错题本')<0){ console.error('initial output missing'); process.exit(1); }
