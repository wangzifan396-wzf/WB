...
const w=dom.window;
if(!w.NotesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Markdown笔记')<0){ console.error('initial output missing'); process.exit(1); }
