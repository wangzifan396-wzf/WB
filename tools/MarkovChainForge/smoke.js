...
const w=dom.window;
if(!w.MarkovChainForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('马尔可夫')<0){ console.error('initial output missing'); process.exit(1); }
