...
const w=dom.window;
if(!w.BdpForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BdpForge')<0){ console.error('initial output missing'); process.exit(1); }
