...
const w=dom.window;
if(!w.EditDistanceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('编辑距离')<0){ console.error('initial output missing'); process.exit(1); }
