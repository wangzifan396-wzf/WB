...
const w=dom.window;
if(!w.CohenDForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('效应量')<0){ console.error('initial output missing'); process.exit(1); }
