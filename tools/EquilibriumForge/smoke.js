...
const w=dom.window;
if(!w.EquilibriumForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('化学平衡常数')<0){ console.error('initial output missing'); process.exit(1); }
