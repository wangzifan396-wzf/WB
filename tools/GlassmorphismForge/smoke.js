...
const w=dom.window;
if(!w.GlassmorphismForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GlassmorphismForge')<0){ console.error('initial output missing'); process.exit(1); }
