...
const w=dom.window;
if(!w.ResumeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('简历生成')<0){ console.error('initial output missing'); process.exit(1); }
