...
const w=dom.window;
if(!w.VaccineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VaccineForge')<0){ console.error('initial output missing'); process.exit(1); }
