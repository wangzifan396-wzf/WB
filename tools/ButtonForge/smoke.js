...
const w=dom.window;
if(!w.ButtonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ButtonForge')<0){ console.error('initial output missing'); process.exit(1); }
