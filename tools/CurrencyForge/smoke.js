...
const w=dom.window;
if(!w.CurrencyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CurrencyForge')<0){ console.error('initial output missing'); process.exit(1); }
