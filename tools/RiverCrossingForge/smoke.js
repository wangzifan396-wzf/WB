...
const w=dom.window;
if(!w.RiverCrossingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“查看解法”得到最少步骤过河方案')<0){ console.error('initial output missing'); process.exit(1); }
