...
const w=dom.window;
if(!w.SegmentTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('线段树')<0){ console.error('initial output missing'); process.exit(1); }
