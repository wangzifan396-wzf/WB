...
const w=dom.window;
if(!w.TaxForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('累进所得税')<0){ console.error('initial output missing'); process.exit(1); }
