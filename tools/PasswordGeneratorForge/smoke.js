...
const w=dom.window;
if(!w.PasswordGeneratorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('强密码生成')<0){ console.error('initial output missing'); process.exit(1); }
