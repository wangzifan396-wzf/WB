...
const w=dom.window;
if(!w.ValidatorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ValidatorForge')<0){ console.error('initial output missing'); process.exit(1); }
