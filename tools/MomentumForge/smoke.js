...
const w=dom.window;
if(!w.MomentumForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('动量/碰撞')<0){ console.error('initial output missing'); process.exit(1); }
