...
const w=dom.window;
if(!w.ActivationEnergyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('活化能')<0){ console.error('initial output missing'); process.exit(1); }
