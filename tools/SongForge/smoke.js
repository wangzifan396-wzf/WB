...
const w=dom.window;
if(!w.SongForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SongForge')<0){ console.error('initial output missing'); process.exit(1); }
