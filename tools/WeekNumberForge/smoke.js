...
const w=dom.window;
if(!w.WeekNumberForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WeekNumberForge')<0){ console.error('initial output missing'); process.exit(1); }
