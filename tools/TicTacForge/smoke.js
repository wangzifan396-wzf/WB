...
const w=dom.window;
if(!w.TicTacForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('井字棋')<0){ console.error('initial output missing'); process.exit(1); }
