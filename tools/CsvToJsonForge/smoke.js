...
const w=dom.window;
if(!w.CsvToJsonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CSV↔JSON')<0){ console.error('initial output missing'); process.exit(1); }
