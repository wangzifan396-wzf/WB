...
const w=dom.window;
if(!w.StegoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StegoForge')<0){ console.error('initial output missing'); process.exit(1); }
