...
const w=dom.window;
if(!w.SigFigForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('有效数字')<0){ console.error('initial output missing'); process.exit(1); }
