...
const w=dom.window;
if(!w.ExtractForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待提取')<0){ console.error('initial output missing'); process.exit(1); }
