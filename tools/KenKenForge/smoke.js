...
const w=dom.window;
if(!w.KenKenForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('在每个格子输入 1..N，使每行每列不重复且 cage 达标')<0){ console.error('initial output missing'); process.exit(1); }
