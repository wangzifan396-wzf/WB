...
const w=dom.window;
if(!w.BloodAlcoholForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('血液酒精估算')<0){ console.error('initial output missing'); process.exit(1); }
