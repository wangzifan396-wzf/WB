...
const w=dom.window;
if(!w.KatakanaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('片假名练习')<0){ console.error('initial output missing'); process.exit(1); }
