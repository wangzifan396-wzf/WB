...
const w=dom.window;
if(!w.WorkoutForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WorkoutForge')<0){ console.error('initial output missing'); process.exit(1); }
