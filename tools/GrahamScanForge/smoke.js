...
const w=dom.window;
if(!w.GrahamScanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('凸包')<0){ console.error('initial output missing'); process.exit(1); }
