...
const w=dom.window;
if(!w.MatrixCalcForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MatrixCalcForge')<0){ console.error('initial output missing'); process.exit(1); }
