...
const w=dom.window;
if(!w.PasswordPolicyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PasswordPolicyForge')<0){ console.error('initial output missing'); process.exit(1); }
