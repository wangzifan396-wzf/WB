...
ok('Cat vector', A.uuEncStr('Cat').indexOf('#0V%T')>=0);
ok('roundtrip', A.uuDecStr(A.uuEncStr('The quick brown fox'))==='The quick brown fox');
console.log('UuencodeForge _test: '+pass+' passed, '+fail+' failed'); process.exit(fail?1:0);
