...
const w=dom.window;
if(!w.KeyFinderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('调性识别')<0){ console.error('initial output missing'); process.exit(1); }
