...
const w=dom.window;
if(!w.CssForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CSS压缩')<0){ console.error('initial output missing'); process.exit(1); }
