...
const w=dom.window;
if(!w.TarotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待抽牌')<0){ console.error('initial output missing'); process.exit(1); }
