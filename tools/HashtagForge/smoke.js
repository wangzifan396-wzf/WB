...
const w=dom.window;
if(!w.HashtagForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('话题标签生成')<0){ console.error('initial output missing'); process.exit(1); }
