...
const w=dom.window;
if(!w.CssFormatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CSS美化')<0){ console.error('initial output missing'); process.exit(1); }
