...
const w=dom.window;
if(!w.TriviaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('知识问答')<0){ console.error('initial output missing'); process.exit(1); }
