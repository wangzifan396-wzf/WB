...
const w=dom.window;
if(!w.RunbookForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RunbookForge')<0){ console.error('initial output missing'); process.exit(1); }
