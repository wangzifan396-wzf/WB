...
const w=dom.window;
if(!w.CompressorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CompressorForge')<0){ console.error('initial output missing'); process.exit(1); }
