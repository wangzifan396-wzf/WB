...
const w=dom.window;
if(!w.EquationBalancerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EquationBalancerForge')<0){ console.error('initial output missing'); process.exit(1); }
