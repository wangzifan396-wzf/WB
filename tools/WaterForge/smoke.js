...
const w=dom.window;
if(!w.WaterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('饮水目标')<0){ console.error('initial output missing'); process.exit(1); }
