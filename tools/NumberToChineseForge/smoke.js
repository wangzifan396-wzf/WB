...
const w=dom.window;
if(!w.NumberToChineseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('数字转中文')<0){ console.error('initial output missing'); process.exit(1); }
