...
const w=dom.window;
if(!w.LeaseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('租车月供')<0){ console.error('initial output missing'); process.exit(1); }
