...
const w=dom.window;
if(!w.SlidingPuzzleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“新游戏”洗牌，把数字按顺序滑回')<0){ console.error('initial output missing'); process.exit(1); }
