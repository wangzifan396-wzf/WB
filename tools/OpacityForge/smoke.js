...
const w=dom.window;
if(!w.OpacityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('颜色透明度')<0){ console.error('initial output missing'); process.exit(1); }
