...
const w=dom.window;
if(!w.ContinuedFractionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('连分数')<0){ console.error('initial output missing'); process.exit(1); }
