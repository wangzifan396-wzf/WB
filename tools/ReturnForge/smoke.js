...
const w=dom.window;
if(!w.ReturnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('投资回报')<0){ console.error('initial output missing'); process.exit(1); }
