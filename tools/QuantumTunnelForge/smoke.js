...
const w=dom.window;
if(!w.QuantumTunnelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('量子隧穿')<0){ console.error('initial output missing'); process.exit(1); }
