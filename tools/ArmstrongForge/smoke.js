...
const w=dom.window;
if(!w.ArmstrongForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ArmstrongForge')<0){ console.error('initial output missing'); process.exit(1); }
