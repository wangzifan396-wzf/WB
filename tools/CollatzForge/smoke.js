...
const w=dom.window;
if(!w.CollatzForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CollatzForge')<0){ console.error('initial output missing'); process.exit(1); }
