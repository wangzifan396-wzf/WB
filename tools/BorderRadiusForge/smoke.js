...
const w=dom.window;
if(!w.BorderRadiusForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BorderRadiusForge')<0){ console.error('initial output missing'); process.exit(1); }
