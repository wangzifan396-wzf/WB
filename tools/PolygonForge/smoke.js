...
const w=dom.window;
if(!w.PolygonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('正多边形')<0){ console.error('initial output missing'); process.exit(1); }
