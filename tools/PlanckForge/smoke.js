...
const w=dom.window;
if(!w.PlanckForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('维恩位移')<0){ console.error('initial output missing'); process.exit(1); }
