...
const w=dom.window;
if(!w.SpacingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('间距刻度')<0){ console.error('initial output missing'); process.exit(1); }
