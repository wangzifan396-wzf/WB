...
const w=dom.window;
if(!w.ExcuseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('借口生成')<0){ console.error('initial output missing'); process.exit(1); }
