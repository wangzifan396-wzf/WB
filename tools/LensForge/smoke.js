...
const w=dom.window;
if(!w.LensForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('薄透镜成像')<0){ console.error('initial output missing'); process.exit(1); }
