...
const w=dom.window;
if(!w.MolarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('溶液浓度')<0){ console.error('initial output missing'); process.exit(1); }
