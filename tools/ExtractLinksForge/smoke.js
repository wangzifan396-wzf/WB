...
const w=dom.window;
if(!w.ExtractLinksForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('链接提取器')<0){ console.error('initial output missing'); process.exit(1); }
