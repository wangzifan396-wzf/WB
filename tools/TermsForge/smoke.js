...
const w=dom.window;
if(!w.TermsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TermsForge')<0){ console.error('initial output missing'); process.exit(1); }
