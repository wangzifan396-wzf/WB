...
const w=dom.window;
if(!w.HtmlFormatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HTML格式化')<0){ console.error('initial output missing'); process.exit(1); }
