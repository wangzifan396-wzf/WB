...
const w=dom.window;
if(!w.TotientForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('欧拉函数 φ(n)')<0){ console.error('initial output missing'); process.exit(1); }
