...
const w=dom.window;
if(!w.GlasgowForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GlasgowForge')<0){ console.error('initial output missing'); process.exit(1); }
