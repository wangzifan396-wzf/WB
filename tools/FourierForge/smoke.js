...
const w=dom.window;
if(!w.FourierForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('离散傅里叶')<0){ console.error('initial output missing'); process.exit(1); }
