...
const w=dom.window;
if(!w.DiffieHellmanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DH密钥交换')<0){ console.error('initial output missing'); process.exit(1); }
