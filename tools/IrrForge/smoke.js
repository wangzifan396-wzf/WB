...
const w=dom.window;
if(!w.IrrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('IrrForge')<0){ console.error('initial output missing'); process.exit(1); }
