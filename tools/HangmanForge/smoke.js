...
const w=dom.window;
if(!w.HangmanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('猜一个字母')<0){ console.error('initial output missing'); process.exit(1); }
