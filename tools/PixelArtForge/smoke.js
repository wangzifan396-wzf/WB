...
const w=dom.window;
if(!w.PixelArtForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PixelArtForge')<0){ console.error('initial output missing'); process.exit(1); }
