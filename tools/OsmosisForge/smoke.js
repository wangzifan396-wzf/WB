...
const w=dom.window;
if(!w.OsmosisForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('渗透压')<0){ console.error('initial output missing'); process.exit(1); }
