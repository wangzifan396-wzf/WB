...
const w=dom.window;
if(!w.ZScoreForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('标准分')<0){ console.error('initial output missing'); process.exit(1); }
