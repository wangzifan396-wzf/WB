...
const w=dom.window;
if(!w.ListForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('列表处理')<0){ console.error('initial output missing'); process.exit(1); }
