...
const w=dom.window;
if(!w.TongueTwisterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('绕口令')<0){ console.error('initial output missing'); process.exit(1); }
