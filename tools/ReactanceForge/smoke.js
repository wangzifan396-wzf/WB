...
const w=dom.window;
if(!w.ReactanceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('交流电抗')<0){ console.error('initial output missing'); process.exit(1); }
