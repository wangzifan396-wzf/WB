...
const w=dom.window;
if(!w.OrbitForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('轨道与逃逸速度')<0){ console.error('initial output missing'); process.exit(1); }
