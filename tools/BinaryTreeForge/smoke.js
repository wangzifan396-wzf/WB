...
const w=dom.window;
if(!w.BinaryTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('二叉树遍历')<0){ console.error('initial output missing'); process.exit(1); }
