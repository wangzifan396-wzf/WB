...
const w=dom.window;
if(!w.UriForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('URI 解析')<0){ console.error('initial output missing'); process.exit(1); }
