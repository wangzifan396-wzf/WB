...
const w=dom.window;
if(!w.ThermoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('温标换算与热量')<0){ console.error('initial output missing'); process.exit(1); }
