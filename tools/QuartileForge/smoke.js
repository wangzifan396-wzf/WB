...
const w=dom.window;
if(!w.QuartileForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('四分位数')<0){ console.error('initial output missing'); process.exit(1); }
