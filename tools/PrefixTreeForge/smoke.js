...
const w=dom.window;
if(!w.PrefixTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('字典树')<0){ console.error('initial output missing'); process.exit(1); }
