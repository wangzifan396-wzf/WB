...
const w=dom.window;
if(!w.AstrologyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('星座查询')<0){ console.error('initial output missing'); process.exit(1); }
