...
const w=dom.window;
if(!w.TriangularForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TriangularForge')<0){ console.error('initial output missing'); process.exit(1); }
