...
const w=dom.window;
if(!w.NetWorthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NetWorthForge')<0){ console.error('initial output missing'); process.exit(1); }
