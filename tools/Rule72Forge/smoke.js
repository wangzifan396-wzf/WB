...
const w=dom.window;
if(!w.Rule72ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Rule72Forge')<0){ console.error('initial output missing'); process.exit(1); }
