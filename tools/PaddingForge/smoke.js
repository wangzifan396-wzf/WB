...
const w=dom.window;
if(!w.PaddingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('内外边距')<0){ console.error('initial output missing'); process.exit(1); }
