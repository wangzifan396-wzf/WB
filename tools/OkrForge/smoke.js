...
const w=dom.window;
if(!w.OkrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('OKR 模板')<0){ console.error('initial output missing'); process.exit(1); }
