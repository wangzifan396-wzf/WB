...
const w=dom.window;
if(!w.DecisionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('决策矩阵')<0){ console.error('initial output missing'); process.exit(1); }
