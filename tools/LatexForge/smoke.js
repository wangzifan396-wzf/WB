...
const w=dom.window;
if(!w.LatexForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待渲染')<0){ console.error('initial output missing'); process.exit(1); }
