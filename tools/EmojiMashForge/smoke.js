...
const w=dom.window;
if(!w.EmojiMashForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EmojiMashForge')<0){ console.error('initial output missing'); process.exit(1); }
