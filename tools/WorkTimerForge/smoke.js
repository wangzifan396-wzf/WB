...
const w=dom.window;
if(!w.WorkTimerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WorkTimerForge')<0){ console.error('initial output missing'); process.exit(1); }
