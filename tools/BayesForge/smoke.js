...
const w=dom.window;
if(!w.BayesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('贝叶斯定理')<0){ console.error('initial output missing'); process.exit(1); }
