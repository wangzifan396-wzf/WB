...
const w=dom.window;
if(!w.JsonTypesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JSON转类型')<0){ console.error('initial output missing'); process.exit(1); }
