...
const w=dom.window;
if(!w.Ascii85ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ASCII85编解码')<0){ console.error('initial output missing'); process.exit(1); }
