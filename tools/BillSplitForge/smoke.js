...
const w=dom.window;
if(!w.BillSplitForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BillSplitForge')<0){ console.error('initial output missing'); process.exit(1); }
