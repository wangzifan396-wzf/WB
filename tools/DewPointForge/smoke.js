...
const w=dom.window;
if(!w.DewPointForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('露点湿度')<0){ console.error('initial output missing'); process.exit(1); }
