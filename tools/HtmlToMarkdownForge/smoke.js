...
const w=dom.window;
if(!w.HtmlToMarkdownForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HTML 转 Markdown')<0){ console.error('initial output missing'); process.exit(1); }
