...
const w=dom.window;
if(!w.CardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('卡片组件')<0){ console.error('initial output missing'); process.exit(1); }
