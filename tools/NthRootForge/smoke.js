...
const w=dom.window;
if(!w.NthRootForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('N 次根')<0){ console.error('initial output missing'); process.exit(1); }
