...
const w=dom.window;
if(!w.JoinForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待合并')<0){ console.error('initial output missing'); process.exit(1); }
