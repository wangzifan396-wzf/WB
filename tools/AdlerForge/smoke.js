...
const w=dom.window;
if(!w.__AdlerForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AdlerForge')<0){ console.error('initial output missing'); process.exit(1); }
