...
const w=dom.window;
if(!w.GeneticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GeneticForge')<0){ console.error('initial output missing'); process.exit(1); }
