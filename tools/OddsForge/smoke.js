...
const w=dom.window;
if(!w.OddsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('OddsForge')<0){ console.error('initial output missing'); process.exit(1); }
