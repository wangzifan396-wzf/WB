...
const w=dom.window;
if(!w.EmbedForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('余弦相似度')<0){ console.error('initial output missing'); process.exit(1); }
