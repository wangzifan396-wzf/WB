...
const w=dom.window;
if(!w.PickupLineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PickupLineForge')<0){ console.error('initial output missing'); process.exit(1); }
