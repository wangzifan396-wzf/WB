...
const w=dom.window;
if(!w.AnovaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('方差分析')<0){ console.error('initial output missing'); process.exit(1); }
