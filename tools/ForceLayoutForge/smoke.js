...
const w=dom.window;
if(!w.ForceLayoutForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('力导向布局')<0){ console.error('initial output missing'); process.exit(1); }
