...
const w=dom.window;
if(!w.AvlTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AVL树')<0){ console.error('initial output missing'); process.exit(1); }
