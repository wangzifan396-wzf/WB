...
const w=dom.window;
if(!w.NNPlaygroundForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NNPlaygroundForge')<0){ console.error('initial output missing'); process.exit(1); }
