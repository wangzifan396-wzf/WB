...
const w=dom.window;
if(!w.AudioMergeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音频合并')<0){ console.error('initial output missing'); process.exit(1); }
