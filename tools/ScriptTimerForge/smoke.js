...
const w=dom.window;
if(!w.ScriptTimerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ScriptTimerForge')<0){ console.error('initial output missing'); process.exit(1); }
