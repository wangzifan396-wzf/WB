...
const w=dom.window;
if(!w.CoverForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CoverForge')<0){ console.error('initial output missing'); process.exit(1); }
