...
const w=dom.window;
if(!w.SvgPlaceholderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SVG占位图')<0){ console.error('initial output missing'); process.exit(1); }
