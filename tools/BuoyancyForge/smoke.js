...
const w=dom.window;
if(!w.BuoyancyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('阿基米德浮力')<0){ console.error('initial output missing'); process.exit(1); }
