...
const w=dom.window;
if(!w.TextRepeatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TextRepeatForge')<0){ console.error('initial output missing'); process.exit(1); }
