...
const w=dom.window;
if(!w.NgramForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NgramForge')<0){ console.error('initial output missing'); process.exit(1); }
