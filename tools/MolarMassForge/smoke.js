...
const w=dom.window;
if(!w.MolarMassForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MolarMassForge')<0){ console.error('initial output missing'); process.exit(1); }
