...
const w=dom.window;
if(!w.VolumeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('三维体积表面积')<0){ console.error('initial output missing'); process.exit(1); }
