...
const w=dom.window;
if(!w.BsonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('选择编码或解码')<0){ console.error('initial output missing'); process.exit(1); }
