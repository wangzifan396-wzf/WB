...
const w=dom.window;
if(!w.Magic8ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待提问')<0){ console.error('initial output missing'); process.exit(1); }
