...
const w=dom.window;
if(!w.BlurForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('毛玻璃')<0){ console.error('initial output missing'); process.exit(1); }
