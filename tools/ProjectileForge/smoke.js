...
const w=dom.window;
if(!w.ProjectileForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('抛体运动计算器')<0){ console.error('initial output missing'); process.exit(1); }
