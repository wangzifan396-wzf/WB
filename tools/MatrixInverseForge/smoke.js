...
const w=dom.window;
if(!w.MatrixInverseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('矩阵求逆')<0){ console.error('initial output missing'); process.exit(1); }
