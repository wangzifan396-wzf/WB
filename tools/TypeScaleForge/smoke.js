...
const w=dom.window;
if(!w.TypeScaleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('排版比例')<0){ console.error('initial output missing'); process.exit(1); }
