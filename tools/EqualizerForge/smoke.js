...
const w=dom.window;
if(!w.EqualizerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('等待计算')<0){ console.error('initial output missing'); process.exit(1); }
