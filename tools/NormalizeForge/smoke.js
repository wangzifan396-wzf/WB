...
const w=dom.window;
if(!w.NormalizeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NormalizeForge')<0){ console.error('initial output missing'); process.exit(1); }
