...
const w=dom.window;
if(!w.MetaphorForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('隐喻生成')<0){ console.error('initial output missing'); process.exit(1); }
