...
const w=dom.window;
if(!w.CryptoPnlForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CryptoPnlForge')<0){ console.error('initial output missing'); process.exit(1); }
