...
const w=dom.window;
if(!w.URLEncodeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('URL 编解码')<0){ console.error('initial output missing'); process.exit(1); }
