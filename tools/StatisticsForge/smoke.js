...
const w=dom.window;
if(!w.StatisticsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('描述统计')<0){ console.error('initial output missing'); process.exit(1); }
