...
const w=dom.window;
if(!w.ReadingLevelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('英文可读性')<0){ console.error('initial output missing'); process.exit(1); }
