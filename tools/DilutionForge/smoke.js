...
const w=dom.window;
if(!w.DilutionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('溶液稀释')<0){ console.error('initial output missing'); process.exit(1); }
