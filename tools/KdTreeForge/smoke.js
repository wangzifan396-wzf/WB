...
const w=dom.window;
if(!w.KdTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KD树')<0){ console.error('initial output missing'); process.exit(1); }
