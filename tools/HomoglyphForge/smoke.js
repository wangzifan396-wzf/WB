...
const w=dom.window;
if(!w.HomoglyphForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入文本后点“生成同形字”')<0){ console.error('initial output missing'); process.exit(1); }
