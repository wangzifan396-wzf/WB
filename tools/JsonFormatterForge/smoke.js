...
const w=dom.window;
if(!w.JsonFormatterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JSON格式化')<0){ console.error('initial output missing'); process.exit(1); }
