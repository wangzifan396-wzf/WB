...
const w=dom.window;
if(!w.ImagePaletteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ImagePaletteForge')<0){ console.error('initial output missing'); process.exit(1); }
