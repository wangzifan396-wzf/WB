...
const w=dom.window;
if(!w.MortgageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('房贷计算器')<0){ console.error('initial output missing'); process.exit(1); }
