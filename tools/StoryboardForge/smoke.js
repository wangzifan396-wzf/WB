...
const w=dom.window;
if(!w.StoryboardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StoryboardForge')<0){ console.error('initial output missing'); process.exit(1); }
