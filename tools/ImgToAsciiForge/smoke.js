...
const w=dom.window;
if(!w.ImgToAsciiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片转ASCII')<0){ console.error('initial output missing'); process.exit(1); }
