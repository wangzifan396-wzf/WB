...
const w=dom.window;
if(!w.__ChooseForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChooseForge')<0){ console.error('initial output missing'); process.exit(1); }
