...
const w=dom.window;
if(!w.SaturationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SaturationForge')<0){ console.error('initial output missing'); process.exit(1); }
