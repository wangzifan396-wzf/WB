...
const w=dom.window;
if(!w.CreditCardPayoffForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CreditCardPayoffForge')<0){ console.error('initial output missing'); process.exit(1); }
