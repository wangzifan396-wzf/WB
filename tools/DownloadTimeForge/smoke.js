...
const w=dom.window;
if(!w.DownloadTimeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('下载时间估算')<0){ console.error('initial output missing'); process.exit(1); }
