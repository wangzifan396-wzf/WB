...
const w=dom.window;
if(!w.SipForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SipForge')<0){ console.error('initial output missing'); process.exit(1); }
