...
const w=dom.window;
if(!w.PresentValueForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('现值 PV')<0){ console.error('initial output missing'); process.exit(1); }
