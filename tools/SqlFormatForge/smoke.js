...
const w=dom.window;
if(!w.SqlFormatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SQL格式化')<0){ console.error('initial output missing'); process.exit(1); }
