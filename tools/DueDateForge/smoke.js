...
const w=dom.window;
if(!w.DueDateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('预产期')<0){ console.error('initial output missing'); process.exit(1); }
