...
const w=dom.window;
if(!w.ExponentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('幂运算')<0){ console.error('initial output missing'); process.exit(1); }
