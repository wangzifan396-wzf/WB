...
const w=dom.window;
if(!w.UserAgentForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UA解析')<0){ console.error('initial output missing'); process.exit(1); }
