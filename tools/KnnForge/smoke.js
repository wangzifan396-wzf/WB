...
const w=dom.window;
if(!w.KnnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KnnForge')<0){ console.error('initial output missing'); process.exit(1); }
