...
const w=dom.window;
if(!w.LoremCnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('中文假文')<0){ console.error('initial output missing'); process.exit(1); }
