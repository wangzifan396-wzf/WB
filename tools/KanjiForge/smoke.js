...
const w=dom.window;
if(!w.KanjiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('日语汉字')<0){ console.error('initial output missing'); process.exit(1); }
