...
const w=dom.window;
if(!w.PixelateForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片像素化')<0){ console.error('initial output missing'); process.exit(1); }
