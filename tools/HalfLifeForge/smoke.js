...
const w=dom.window;
if(!w.HalfLifeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HalfLifeForge')<0){ console.error('initial output missing'); process.exit(1); }
