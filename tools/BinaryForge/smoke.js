...
const w=dom.window;
if(!w.BinaryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本二进制')<0){ console.error('initial output missing'); process.exit(1); }
