...
const w=dom.window;
if(!w.EllipticCurveForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('椭圆曲线')<0){ console.error('initial output missing'); process.exit(1); }
