...
const w=dom.window;
if(!w.CheatSheetForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('速查表')<0){ console.error('initial output missing'); process.exit(1); }
