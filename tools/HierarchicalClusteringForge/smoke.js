...
const w=dom.window;
if(!w.HierarchicalClusteringForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('层次聚类')<0){ console.error('initial output missing'); process.exit(1); }
