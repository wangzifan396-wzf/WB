...
const w=dom.window;
if(!w.BloodTypeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BloodTypeForge')<0){ console.error('initial output missing'); process.exit(1); }
