...
const w=dom.window;
if(!w.RedactForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入文本后点“脱敏”')<0){ console.error('initial output missing'); process.exit(1); }
