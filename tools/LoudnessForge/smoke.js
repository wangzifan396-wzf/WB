...
const w=dom.window;
if(!w.LoudnessForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LoudnessForge')<0){ console.error('initial output missing'); process.exit(1); }
