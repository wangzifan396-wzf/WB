...
const w=dom.window;
if(!w.DistortionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DistortionForge')<0){ console.error('initial output missing'); process.exit(1); }
