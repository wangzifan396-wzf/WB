...
const w=dom.window;
if(!w.BeerLawForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('比尔-朗伯定律')<0){ console.error('initial output missing'); process.exit(1); }
