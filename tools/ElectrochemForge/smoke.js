...
const w=dom.window;
if(!w.ElectrochemForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电化学')<0){ console.error('initial output missing'); process.exit(1); }
