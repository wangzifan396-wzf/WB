...
const w=dom.window;
if(!w.CaptionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CaptionForge')<0){ console.error('initial output missing'); process.exit(1); }
