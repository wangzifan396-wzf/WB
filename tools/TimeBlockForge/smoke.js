...
const w=dom.window;
if(!w.TimeBlockForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TimeBlockForge')<0){ console.error('initial output missing'); process.exit(1); }
