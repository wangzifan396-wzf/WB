...
const w=dom.window;
if(!w.HarshadForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HarshadForge')<0){ console.error('initial output missing'); process.exit(1); }
