...
const w=dom.window;
if(!w.ConvolverForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ConvolverForge')<0){ console.error('initial output missing'); process.exit(1); }
