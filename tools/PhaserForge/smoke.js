...
const w=dom.window;
if(!w.PhaserForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PhaserForge')<0){ console.error('initial output missing'); process.exit(1); }
