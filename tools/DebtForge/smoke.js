...
const w=dom.window;
if(!w.DebtForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('债务清偿')<0){ console.error('initial output missing'); process.exit(1); }
