...
const w=dom.window;
if(!w.CholesterolForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CholesterolForge')<0){ console.error('initial output missing'); process.exit(1); }
