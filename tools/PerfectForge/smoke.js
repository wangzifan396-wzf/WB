...
const w=dom.window;
if(!w.PerfectForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PerfectForge')<0){ console.error('initial output missing'); process.exit(1); }
