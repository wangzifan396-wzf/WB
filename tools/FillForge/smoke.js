...
const w=dom.window;
if(!w.FillForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本对齐')<0){ console.error('initial output missing'); process.exit(1); }
