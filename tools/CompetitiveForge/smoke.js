...
const w=dom.window;
if(!w.CompetitiveForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CompetitiveForge')<0){ console.error('initial output missing'); process.exit(1); }
