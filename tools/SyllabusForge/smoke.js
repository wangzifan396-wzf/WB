...
const w=dom.window;
if(!w.SyllabusForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SyllabusForge')<0){ console.error('initial output missing'); process.exit(1); }
