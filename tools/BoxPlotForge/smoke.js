...
const w=dom.window;
if(!w.BoxPlotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BoxPlotForge')<0){ console.error('initial output missing'); process.exit(1); }
