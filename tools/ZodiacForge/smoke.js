...
const w=dom.window;
if(!w.ZodiacForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ZodiacForge')<0){ console.error('initial output missing'); process.exit(1); }
