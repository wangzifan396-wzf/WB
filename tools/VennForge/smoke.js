...
const w=dom.window;
if(!w.VennForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VennForge')<0){ console.error('initial output missing'); process.exit(1); }
