...
const w=dom.window;
if(!w.ProteinForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('蛋白质序列翻译')<0){ console.error('initial output missing'); process.exit(1); }
