...
const w=dom.window;
if(!w.BondPricingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BondPricingForge')<0){ console.error('initial output missing'); process.exit(1); }
