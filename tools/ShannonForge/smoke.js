...
const w=dom.window;
if(!w.ShannonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('香农熵')<0){ console.error('initial output missing'); process.exit(1); }
