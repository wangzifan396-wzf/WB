...
const w=dom.window;
if(!w.SunburstForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SunburstForge')<0){ console.error('initial output missing'); process.exit(1); }
