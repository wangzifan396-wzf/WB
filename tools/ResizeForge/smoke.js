...
const w=dom.window;
if(!w.ResizeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('图片缩放')<0){ console.error('initial output missing'); process.exit(1); }
