...
const w=dom.window;
if(!w.MacrosForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('宏量营养')<0){ console.error('initial output missing'); process.exit(1); }
