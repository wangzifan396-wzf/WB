...
const w=dom.window;
if(!w.UrlScanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('URL扫描')<0){ console.error('initial output missing'); process.exit(1); }
