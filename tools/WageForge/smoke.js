...
const w=dom.window;
if(!w.WageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('WageForge')<0){ console.error('initial output missing'); process.exit(1); }
