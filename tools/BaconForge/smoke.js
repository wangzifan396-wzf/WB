...
const w=dom.window;
if(!w.BaconForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入明文后点“编码”')<0){ console.error('initial output missing'); process.exit(1); }
