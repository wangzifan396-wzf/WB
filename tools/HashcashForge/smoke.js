...
const w=dom.window;
if(!w.HashcashForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“生成 stamp”开始算力证明')<0){ console.error('initial output missing'); process.exit(1); }
