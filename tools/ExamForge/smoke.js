...
const w=dom.window;
if(!w.ExamForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ExamForge')<0){ console.error('initial output missing'); process.exit(1); }
