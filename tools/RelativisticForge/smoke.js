...
const w=dom.window;
if(!w.RelativisticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('狭义相对论')<0){ console.error('initial output missing'); process.exit(1); }
