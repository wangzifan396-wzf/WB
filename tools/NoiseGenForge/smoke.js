...
const w=dom.window;
if(!w.NoiseGenForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('噪声生成')<0){ console.error('initial output missing'); process.exit(1); }
