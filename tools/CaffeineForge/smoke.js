...
const w=dom.window;
if(!w.CaffeineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('咖啡因浓度')<0){ console.error('initial output missing'); process.exit(1); }
