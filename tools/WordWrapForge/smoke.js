...
const w=dom.window;
if(!w.WordWrapForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('智能折行')<0){ console.error('initial output missing'); process.exit(1); }
