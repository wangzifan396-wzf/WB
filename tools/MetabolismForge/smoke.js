...
const w=dom.window;
if(!w.MetabolismForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BMR/TDEE')<0){ console.error('initial output missing'); process.exit(1); }
