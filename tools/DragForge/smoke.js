...
const w=dom.window;
if(!w.DragForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('空气阻力')<0){ console.error('initial output missing'); process.exit(1); }
