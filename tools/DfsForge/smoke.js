...
const w=dom.window;
if(!w.DfsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('深度优先遍历')<0){ console.error('initial output missing'); process.exit(1); }
