...
const w=dom.window;
if(!w.SnellsLawForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('折射定律')<0){ console.error('initial output missing'); process.exit(1); }
