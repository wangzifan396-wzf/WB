...
const w=dom.window;
if(!w.EchoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('音频回声')<0){ console.error('initial output missing'); process.exit(1); }
