...
const w=dom.window;
if(!w.HiraganaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('平假名练习')<0){ console.error('initial output missing'); process.exit(1); }
