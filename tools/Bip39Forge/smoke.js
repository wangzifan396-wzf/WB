...
const w=dom.window;
if(!w.Bip39ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BIP39助记词')<0){ console.error('initial output missing'); process.exit(1); }
