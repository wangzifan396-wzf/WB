...
const w=dom.window;
if(!w.BackupCodeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BackupCodeForge')<0){ console.error('initial output missing'); process.exit(1); }
