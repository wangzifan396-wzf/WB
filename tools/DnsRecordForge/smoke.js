...
const w=dom.window;
if(!w.DnsRecordForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('解析')<0){ console.error('initial output missing'); process.exit(1); }
