...
const w=dom.window;
if(!w.ChainOfThoughtForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChainOfThoughtForge')<0){ console.error('initial output missing'); process.exit(1); }
