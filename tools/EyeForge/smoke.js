...
const w=dom.window;
if(!w.EyeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EyeForge')<0){ console.error('initial output missing'); process.exit(1); }
