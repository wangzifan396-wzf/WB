...
const w=dom.window;
if(!w.RegexExtractForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('正则提取')<0){ console.error('initial output missing'); process.exit(1); }
