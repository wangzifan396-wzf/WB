...
const w=dom.window;
if(!w.UnionFindForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('并查集')<0){ console.error('initial output missing'); process.exit(1); }
