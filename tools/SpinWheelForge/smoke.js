...
const w=dom.window;
if(!w.SpinWheelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('转盘')<0){ console.error('initial output missing'); process.exit(1); }
