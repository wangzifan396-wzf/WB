...
const w=dom.window;
if(!w.SpinnerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('加载动画')<0){ console.error('initial output missing'); process.exit(1); }
