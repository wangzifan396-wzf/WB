...
const w=dom.window;
if(!w.Crc32ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CRC32校验')<0){ console.error('initial output missing'); process.exit(1); }
