...
const w=dom.window;
if(!w.PromptScoreForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('提示词评分')<0){ console.error('initial output missing'); process.exit(1); }
