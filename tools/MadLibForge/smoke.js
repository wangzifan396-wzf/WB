...
const w=dom.window;
if(!w.MadLibForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('填词游戏')<0){ console.error('initial output missing'); process.exit(1); }
