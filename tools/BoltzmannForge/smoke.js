...
const w=dom.window;
if(!w.BoltzmannForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('玻尔兹曼')<0){ console.error('initial output missing'); process.exit(1); }
