...
const w=dom.window;
if(!w.DelayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('延迟与混响')<0){ console.error('initial output missing'); process.exit(1); }
