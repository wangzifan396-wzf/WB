...
const w=dom.window;
if(!w.GradingRubricForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GradingRubricForge')<0){ console.error('initial output missing'); process.exit(1); }
