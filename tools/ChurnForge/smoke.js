...
const w=dom.window;
if(!w.ChurnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ChurnForge')<0){ console.error('initial output missing'); process.exit(1); }
