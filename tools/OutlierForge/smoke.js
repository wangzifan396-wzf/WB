...
const w=dom.window;
if(!w.OutlierForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('离群值检测')<0){ console.error('initial output missing'); process.exit(1); }
