...
const w=dom.window;
if(!w.HeadlineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HeadlineForge')<0){ console.error('initial output missing'); process.exit(1); }
