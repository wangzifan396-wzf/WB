...
const w=dom.window;
if(!w.AbacusForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('算盘练习')<0){ console.error('initial output missing'); process.exit(1); }
