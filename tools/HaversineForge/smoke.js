...
const w=dom.window;
if(!w.HaversineForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('大圆距离')<0){ console.error('initial output missing'); process.exit(1); }
