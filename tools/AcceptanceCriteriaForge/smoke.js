...
const w=dom.window;
if(!w.AcceptanceCriteriaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AcceptanceCriteriaForge')<0){ console.error('initial output missing'); process.exit(1); }
