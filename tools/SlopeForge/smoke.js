...
const w=dom.window;
if(!w.SlopeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('斜率直线')<0){ console.error('initial output missing'); process.exit(1); }
