...
const w=dom.window;
if(!w.DaysUntilForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DaysUntilForge')<0){ console.error('initial output missing'); process.exit(1); }
