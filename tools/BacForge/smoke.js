...
const w=dom.window;
if(!w.BacForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BacForge')<0){ console.error('initial output missing'); process.exit(1); }
