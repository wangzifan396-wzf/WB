...
const w=dom.window;
if(!w.NeumorphismForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('NeumorphismForge')<0){ console.error('initial output missing'); process.exit(1); }
