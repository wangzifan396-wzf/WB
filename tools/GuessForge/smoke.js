...
const w=dom.window;
if(!w.GuessForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GuessForge')<0){ console.error('initial output missing'); process.exit(1); }
