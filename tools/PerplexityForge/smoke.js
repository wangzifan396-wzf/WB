...
const w=dom.window;
if(!w.PerplexityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PerplexityForge')<0){ console.error('initial output missing'); process.exit(1); }
