...
const w=dom.window;
if(!w.__BaseNForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BaseNForge')<0){ console.error('initial output missing'); process.exit(1); }
