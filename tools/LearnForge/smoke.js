...
const w=dom.window;
if(!w.LearnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('间隔重复')<0){ console.error('initial output missing'); process.exit(1); }
