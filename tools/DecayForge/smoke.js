...
const w=dom.window;
if(!w.DecayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('放射性衰变')<0){ console.error('initial output missing'); process.exit(1); }
