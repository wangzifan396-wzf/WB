...
const w=dom.window;
if(!w.LudoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LudoForge')<0){ console.error('initial output missing'); process.exit(1); }
