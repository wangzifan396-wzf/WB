...
const w=dom.window;
if(!w.VaporPressureForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('VaporPressureForge')<0){ console.error('initial output missing'); process.exit(1); }
