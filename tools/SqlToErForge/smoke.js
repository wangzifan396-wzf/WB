...
const w=dom.window;
if(!w.SqlToErForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SqlToErForge')<0){ console.error('initial output missing'); process.exit(1); }
