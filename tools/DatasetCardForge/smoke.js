...
const w=dom.window;
if(!w.DatasetCardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DatasetCardForge')<0){ console.error('initial output missing'); process.exit(1); }
