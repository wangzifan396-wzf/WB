...
const w=dom.window;
if(!w.RobotsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RobotsForge')<0){ console.error('initial output missing'); process.exit(1); }
