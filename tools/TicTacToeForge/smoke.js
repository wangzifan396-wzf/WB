...
const w=dom.window;
if(!w.TicTacToeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('你的回合（X 先手）')<0){ console.error('initial output missing'); process.exit(1); }
