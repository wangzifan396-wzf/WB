...
const w=dom.window;
if(!w.SortVizForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('选择算法后点“播放”')<0){ console.error('initial output missing'); process.exit(1); }
