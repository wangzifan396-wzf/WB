...
const w=dom.window;
if(!w.MolalityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('质量摩尔浓度')<0){ console.error('initial output missing'); process.exit(1); }
