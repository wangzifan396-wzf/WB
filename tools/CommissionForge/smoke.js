...
const w=dom.window;
if(!w.CommissionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CommissionForge')<0){ console.error('initial output missing'); process.exit(1); }
