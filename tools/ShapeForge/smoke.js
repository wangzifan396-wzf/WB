...
const w=dom.window;
if(!w.ShapeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('面积周长')<0){ console.error('initial output missing'); process.exit(1); }
