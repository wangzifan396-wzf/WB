...
const w=dom.window;
if(!w.RegressionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RegressionForge')<0){ console.error('initial output missing'); process.exit(1); }
