...
const w=dom.window;
if(!w.UrlExtractForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('URL 提取')<0){ console.error('initial output missing'); process.exit(1); }
