...
const w=dom.window;
if(!w.BTreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('B树')<0){ console.error('initial output missing'); process.exit(1); }
