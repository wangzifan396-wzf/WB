...
const w=dom.window;
if(!w.MolarityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MolarityForge')<0){ console.error('initial output missing'); process.exit(1); }
