...
const w=dom.window;
if(!w.ImageDiffForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ImageDiffForge')<0){ console.error('initial output missing'); process.exit(1); }
