...
const w=dom.window;
if(!w.PartitionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('整数分拆数')<0){ console.error('initial output missing'); process.exit(1); }
