...
const w=dom.window;
if(!w.BloomFilterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('布隆过滤器')<0){ console.error('initial output missing'); process.exit(1); }
