...
const w=dom.window;
if(!w.YieldForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('YieldForge')<0){ console.error('initial output missing'); process.exit(1); }
