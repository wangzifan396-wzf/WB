...
const w=dom.window;
if(!w.LuckyDrawForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('抽奖')<0){ console.error('initial output missing'); process.exit(1); }
