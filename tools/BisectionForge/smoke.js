...
const w=dom.window;
if(!w.BisectionForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('二分法')<0){ console.error('initial output missing'); process.exit(1); }
