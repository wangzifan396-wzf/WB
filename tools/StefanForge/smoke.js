...
const w=dom.window;
if(!w.StefanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('斯特藩定律')<0){ console.error('initial output missing'); process.exit(1); }
