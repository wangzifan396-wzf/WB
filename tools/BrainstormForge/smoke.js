...
const w=dom.window;
if(!w.BrainstormForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('构思发散')<0){ console.error('initial output missing'); process.exit(1); }
