...
const w=dom.window;
if(!w.EntropyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('密码熵')<0){ console.error('initial output missing'); process.exit(1); }
