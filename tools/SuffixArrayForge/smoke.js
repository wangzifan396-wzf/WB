...
const w=dom.window;
if(!w.SuffixArrayForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('后缀数组')<0){ console.error('initial output missing'); process.exit(1); }
