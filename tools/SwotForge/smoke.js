...
const w=dom.window;
if(!w.SwotForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SWOT 分析')<0){ console.error('initial output missing'); process.exit(1); }
