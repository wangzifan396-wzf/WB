...
const w=dom.window;
if(!w.ChiSquareForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('卡方检验')<0){ console.error('initial output missing'); process.exit(1); }
