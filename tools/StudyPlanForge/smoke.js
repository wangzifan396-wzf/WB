...
const w=dom.window;
if(!w.StudyPlanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('学习计划')<0){ console.error('initial output missing'); process.exit(1); }
