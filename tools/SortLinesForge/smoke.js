...
const w=dom.window;
if(!w.SortLinesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('行排序')<0){ console.error('initial output missing'); process.exit(1); }
