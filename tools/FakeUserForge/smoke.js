...
const w=dom.window;
if(!w.FakeUserForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('假用户生成')<0){ console.error('initial output missing'); process.exit(1); }
