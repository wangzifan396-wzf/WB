...
const w=dom.window;
if(!w.ReverseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('文本反转')<0){ console.error('initial output missing'); process.exit(1); }
