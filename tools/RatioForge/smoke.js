...
const w=dom.window;
if(!w.RatioForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('比值化简')<0){ console.error('initial output missing'); process.exit(1); }
