...
const w=dom.window;
if(!w.BSTForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('二叉搜索树')<0){ console.error('initial output missing'); process.exit(1); }
