...
const w=dom.window;
if(!w.DigitalRootForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('DigitalRootForge')<0){ console.error('initial output missing'); process.exit(1); }
