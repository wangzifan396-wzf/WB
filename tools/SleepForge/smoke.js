...
const w=dom.window;
if(!w.SleepForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SleepForge')<0){ console.error('initial output missing'); process.exit(1); }
