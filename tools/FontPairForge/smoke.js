...
const w=dom.window;
if(!w.FontPairForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('字体配对')<0){ console.error('initial output missing'); process.exit(1); }
