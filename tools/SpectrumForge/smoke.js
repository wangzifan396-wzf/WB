...
const w=dom.window;
if(!w.SpectrumForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('信号频谱')<0){ console.error('initial output missing'); process.exit(1); }
