...
const w=dom.window;
if(!w.TokenCostForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TokenCostForge')<0){ console.error('initial output missing'); process.exit(1); }
