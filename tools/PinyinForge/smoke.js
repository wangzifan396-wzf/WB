...
const w=dom.window;
if(!w.PinyinForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('汉字转拼音')<0){ console.error('initial output missing'); process.exit(1); }
