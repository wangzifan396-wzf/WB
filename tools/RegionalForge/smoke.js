...
const w=dom.window;
if(!w.RegionalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入字母后点“转换”')<0){ console.error('initial output missing'); process.exit(1); }
