...
const w=dom.window;
if(!w.TruthTableForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('真值表')<0){ console.error('initial output missing'); process.exit(1); }
