...
const w=dom.window;
if(!w.DateAddForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('日期加减')<0){ console.error('initial output missing'); process.exit(1); }
