...
const w=dom.window;
if(!w.SpearmanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('斯皮尔曼相关')<0){ console.error('initial output missing'); process.exit(1); }
