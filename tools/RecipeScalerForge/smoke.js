...
const w=dom.window;
if(!w.RecipeScalerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RecipeScalerForge')<0){ console.error('initial output missing'); process.exit(1); }
