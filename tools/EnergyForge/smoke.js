...
const w=dom.window;
if(!w.EnergyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('能量与做功')<0){ console.error('initial output missing'); process.exit(1); }
