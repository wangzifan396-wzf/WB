...
const w=dom.window;
if(!w.MemeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MemeForge')<0){ console.error('initial output missing'); process.exit(1); }
