...
const w=dom.window;
if(!w.ChineseRemainderForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('中国剩余')<0){ console.error('initial output missing'); process.exit(1); }
