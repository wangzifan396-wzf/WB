...
const w=dom.window;
if(!w.AiAgentSpecForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AiAgentSpecForge')<0){ console.error('initial output missing'); process.exit(1); }
