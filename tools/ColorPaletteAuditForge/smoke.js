...
const w=dom.window;
if(!w.ColorPaletteAuditForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ColorPaletteAuditForge')<0){ console.error('initial output missing'); process.exit(1); }
