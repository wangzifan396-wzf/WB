...
const w=dom.window;
if(!w.VocabForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('词汇卡自测')<0){ console.error('initial output missing'); process.exit(1); }
