...
const w=dom.window;
if(!w.SafeZoneForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SafeZoneForge')<0){ console.error('initial output missing'); process.exit(1); }
