...
const w=dom.window;
if(!w.GasLawsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('气体定律')<0){ console.error('initial output missing'); process.exit(1); }
