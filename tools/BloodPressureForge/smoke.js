...
const w=dom.window;
if(!w.BloodPressureForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('血压分级')<0){ console.error('initial output missing'); process.exit(1); }
