...
const w=dom.window;
if(!w.EquationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('方程求解')<0){ console.error('initial output missing'); process.exit(1); }
