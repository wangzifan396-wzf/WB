...
const w=dom.window;
if(!w.AdrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AdrForge')<0){ console.error('initial output missing'); process.exit(1); }
