...
const w=dom.window;
if(!w.AutocorrelationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('自相关')<0){ console.error('initial output missing'); process.exit(1); }
