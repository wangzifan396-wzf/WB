...
const w=dom.window;
if(!w.SolitaireForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点牌堆顶/废牌选牌，点目标列或基础堆落子')<0){ console.error('initial output missing'); process.exit(1); }
