...
const w=dom.window;
if(!w.CohortForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CohortForge')<0){ console.error('initial output missing'); process.exit(1); }
