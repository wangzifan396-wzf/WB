...
const w=dom.window;
if(!w.SavingsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('储蓄目标')<0){ console.error('initial output missing'); process.exit(1); }
