...
const w=dom.window;
if(!w.FilterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('像素滤镜')<0){ console.error('initial output missing'); process.exit(1); }
