...
const w=dom.window;
if(!w.EmojiStripForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EmojiStripForge')<0){ console.error('initial output missing'); process.exit(1); }
