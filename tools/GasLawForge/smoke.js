...
const w=dom.window;
if(!w.GasLawForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GasLawForge')<0){ console.error('initial output missing'); process.exit(1); }
