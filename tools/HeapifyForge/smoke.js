...
const w=dom.window;
if(!w.HeapifyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('堆')<0){ console.error('initial output missing'); process.exit(1); }
