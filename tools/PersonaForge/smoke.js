...
const w=dom.window;
if(!w.PersonaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PersonaForge')<0){ console.error('initial output missing'); process.exit(1); }
