...
const w=dom.window;
if(!w.GoFishForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“开始”发牌，然后输入一个点数向电脑询问')<0){ console.error('initial output missing'); process.exit(1); }
