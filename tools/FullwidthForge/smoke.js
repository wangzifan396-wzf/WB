...
const w=dom.window;
if(!w.FullwidthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('全角半角')<0){ console.error('initial output missing'); process.exit(1); }
