...
const w=dom.window;
if(!w.NuclearForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('核衰变')<0){ console.error('initial output missing'); process.exit(1); }
