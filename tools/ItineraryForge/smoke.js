...
const w=dom.window;
if(!w.ItineraryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ItineraryForge')<0){ console.error('initial output missing'); process.exit(1); }
