...
const w=dom.window;
if(!w.ConnectForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('你执 ●（红），点击任意列落子')<0){ console.error('initial output missing'); process.exit(1); }
