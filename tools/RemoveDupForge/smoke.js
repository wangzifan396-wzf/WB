...
const w=dom.window;
if(!w.RemoveDupForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('去重行')<0){ console.error('initial output missing'); process.exit(1); }
