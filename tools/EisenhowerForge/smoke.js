...
const w=dom.window;
if(!w.EisenhowerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EisenhowerForge')<0){ console.error('initial output missing'); process.exit(1); }
