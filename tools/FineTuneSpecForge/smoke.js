...
const w=dom.window;
if(!w.FineTuneSpecForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('FineTuneSpecForge')<0){ console.error('initial output missing'); process.exit(1); }
