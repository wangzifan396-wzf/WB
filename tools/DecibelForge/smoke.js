...
const w=dom.window;
if(!w.DecibelForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('分贝与声压级')<0){ console.error('initial output missing'); process.exit(1); }
