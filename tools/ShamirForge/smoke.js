...
const w=dom.window;
if(!w.ShamirForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“拆分”生成份额')<0){ console.error('initial output missing'); process.exit(1); }
