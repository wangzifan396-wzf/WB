...
const w=dom.window;
if(!w.KmerForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('k-mer计数')<0){ console.error('initial output missing'); process.exit(1); }
