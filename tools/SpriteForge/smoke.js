...
const w=dom.window;
if(!w.SpriteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('精灵图切片')<0){ console.error('initial output missing'); process.exit(1); }
