...
const w=dom.window;
if(!w.ChordIdentifierForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('和弦识别')<0){ console.error('initial output missing'); process.exit(1); }
