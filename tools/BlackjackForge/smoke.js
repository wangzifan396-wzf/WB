...
const w=dom.window;
if(!w.BlackjackForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“发牌”开始')<0){ console.error('initial output missing'); process.exit(1); }
