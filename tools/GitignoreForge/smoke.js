...
const w=dom.window;
if(!w.GitignoreForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GitignoreForge')<0){ console.error('initial output missing'); process.exit(1); }
