...
const w=dom.window;
if(!w.RadicalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RadicalForge')<0){ console.error('initial output missing'); process.exit(1); }
