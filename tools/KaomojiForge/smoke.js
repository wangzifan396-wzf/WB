...
const w=dom.window;
if(!w.KaomojiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击表情即可复制')<0){ console.error('initial output missing'); process.exit(1); }
