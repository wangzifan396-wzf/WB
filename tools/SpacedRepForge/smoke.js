...
const w=dom.window;
if(!w.SpacedRepForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SpacedRepForge')<0){ console.error('initial output missing'); process.exit(1); }
