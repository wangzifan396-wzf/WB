...
const w=dom.window;
if(!w.BabyGrowthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BabyGrowthForge')<0){ console.error('initial output missing'); process.exit(1); }
