...
const w=dom.window;
if(!w.ConcreteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ConcreteForge')<0){ console.error('initial output missing'); process.exit(1); }
