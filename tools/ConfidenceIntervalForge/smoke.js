...
const w=dom.window;
if(!w.ConfidenceIntervalForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('置信区间')<0){ console.error('initial output missing'); process.exit(1); }
