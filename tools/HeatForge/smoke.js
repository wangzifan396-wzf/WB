...
const w=dom.window;
if(!w.HeatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HeatForge')<0){ console.error('initial output missing'); process.exit(1); }
