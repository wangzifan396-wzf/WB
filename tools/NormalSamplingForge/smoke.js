...
const w=dom.window;
if(!w.NormalSamplingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('正态抽样')<0){ console.error('initial output missing'); process.exit(1); }
