...
const w=dom.window;
if(!w.BandwidthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('传输估算')<0){ console.error('initial output missing'); process.exit(1); }
