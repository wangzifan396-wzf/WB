...
setTimeout(()=>{ const doc=window.document; let pass=0,fail=0;
  ...
  ok('AvatarForgePure exposed', typeof window.AvatarForgePure==='object');
  ok('gen btn', !!doc.getElementById('gen'));
  doc.getElementById('seed').value='x'; doc.getElementById('gen').click();
  ...
  console.log('AvatarForge smoke: '+pass+' passed, '+fail+' failed');
