...
const w=dom.window;
if(!w.SentenceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('单词乱序')<0){ console.error('initial output missing'); process.exit(1); }
