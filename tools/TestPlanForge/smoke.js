...
const w=dom.window;
if(!w.TestPlanForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TestPlanForge')<0){ console.error('initial output missing'); process.exit(1); }
