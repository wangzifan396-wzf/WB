...
const w=dom.window;
if(!w.PhoneExtractForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('手机号')<0){ console.error('initial output missing'); process.exit(1); }
