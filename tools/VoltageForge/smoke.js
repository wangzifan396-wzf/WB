...
const w=dom.window;
if(!w.VoltageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('电压欧姆')<0){ console.error('initial output missing'); process.exit(1); }
