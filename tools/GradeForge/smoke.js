...
const w=dom.window;
if(!w.GradeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('加权成绩')<0){ console.error('initial output missing'); process.exit(1); }
