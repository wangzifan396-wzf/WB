...
const w=dom.window;
if(!w.PeriodicForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('元素周期表')<0){ console.error('initial output missing'); process.exit(1); }
