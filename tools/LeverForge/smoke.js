...
const w=dom.window;
if(!w.LeverForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LeverForge')<0){ console.error('initial output missing'); process.exit(1); }
