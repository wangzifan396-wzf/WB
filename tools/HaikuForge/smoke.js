...
const w=dom.window;
if(!w.HaikuForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('俳句生成')<0){ console.error('initial output missing'); process.exit(1); }
