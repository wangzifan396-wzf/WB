...
const w=dom.window;
if(!w.PhForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PhForge')<0){ console.error('initial output missing'); process.exit(1); }
