...
const w=dom.window;
if(!w.SpectroscopyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SpectroscopyForge')<0){ console.error('initial output missing'); process.exit(1); }
