...
const w=dom.window;
if(!w.SnowflakeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SnowflakeForge')<0){ console.error('initial output missing'); process.exit(1); }
