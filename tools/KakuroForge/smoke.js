...
const w=dom.window;
if(!w.KakuroForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“新题目”生成一道数和谜题')<0){ console.error('initial output missing'); process.exit(1); }
