...
const w=dom.window;
if(!w.NimForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击某堆中的第 k 枚石子 = 从该堆取走 k 枚')<0){ console.error('initial output missing'); process.exit(1); }
