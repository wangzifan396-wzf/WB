...
const w=dom.window;
if(!w.CalorieBurnForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CalorieBurnForge')<0){ console.error('initial output missing'); process.exit(1); }
