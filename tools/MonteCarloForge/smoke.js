...
const w=dom.window;
if(!w.MonteCarloForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('蒙特卡洛')<0){ console.error('initial output missing'); process.exit(1); }
