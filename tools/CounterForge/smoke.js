...
const w=dom.window;
if(!w.CounterForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('多计数器')<0){ console.error('initial output missing'); process.exit(1); }
