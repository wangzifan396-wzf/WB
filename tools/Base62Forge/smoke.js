...
const w=dom.window;
if(!w.__Base62Forge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('Base62Forge')<0){ console.error('initial output missing'); process.exit(1); }
