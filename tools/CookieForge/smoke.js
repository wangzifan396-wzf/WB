...
const w=dom.window;
if(!w.CookieForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CookieForge')<0){ console.error('initial output missing'); process.exit(1); }
