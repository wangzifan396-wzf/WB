...
const w=dom.window;
if(!w.EnthalpyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('反应焓变')<0){ console.error('initial output missing'); process.exit(1); }
