...
const w=dom.window;
if(!w.BalanceForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('化学方程式配平')<0){ console.error('initial output missing'); process.exit(1); }
