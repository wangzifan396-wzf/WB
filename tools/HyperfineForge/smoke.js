...
const w=dom.window;
if(!w.__HyperfineForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('HyperfineForge')<0){ console.error('initial output missing'); process.exit(1); }
