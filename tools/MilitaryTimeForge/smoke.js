...
const w=dom.window;
if(!w.MilitaryTimeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('24/12 小时制')<0){ console.error('initial output missing'); process.exit(1); }
