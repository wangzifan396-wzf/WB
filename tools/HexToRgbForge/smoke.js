...
const w=dom.window;
if(!w.HexToRgbForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('颜色解析')<0){ console.error('initial output missing'); process.exit(1); }
