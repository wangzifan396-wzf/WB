...
const w=dom.window;
if(!w.AnomalyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AnomalyForge')<0){ console.error('initial output missing'); process.exit(1); }
