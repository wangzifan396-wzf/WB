...
const w=dom.window;
if(!w.CodeImageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('代码截图')<0){ console.error('initial output missing'); process.exit(1); }
