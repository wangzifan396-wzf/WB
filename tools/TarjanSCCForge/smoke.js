...
const w=dom.window;
if(!w.TarjanSCCForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('强连通分量')<0){ console.error('initial output missing'); process.exit(1); }
