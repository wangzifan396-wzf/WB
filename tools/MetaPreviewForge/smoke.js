...
const w=dom.window;
if(!w.MetaPreviewForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SEO预览')<0){ console.error('initial output missing'); process.exit(1); }
