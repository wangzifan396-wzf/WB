...
const w=dom.window;
if(!w.BernoulliForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BernoulliForge')<0){ console.error('initial output missing'); process.exit(1); }
