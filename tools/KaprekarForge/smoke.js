...
const w=dom.window;
if(!w.KaprekarForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KaprekarForge')<0){ console.error('initial output missing'); process.exit(1); }
