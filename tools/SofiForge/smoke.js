...
const w=dom.window;
if(!w.SofiForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SofiForge')<0){ console.error('initial output missing'); process.exit(1); }
