...
const w=dom.window;
if(!w.TypographyForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('字号比例')<0){ console.error('initial output missing'); process.exit(1); }
