...
const w=dom.window;
if(!w.QuadraticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('一元二次方程')<0){ console.error('initial output missing'); process.exit(1); }
