...
const w=dom.window;
if(!w.MeldForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('MeldForge')<0){ console.error('initial output missing'); process.exit(1); }
