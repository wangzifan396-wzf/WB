...
const w=dom.window;
if(!w.LoanPayoffForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('LoanPayoffForge')<0){ console.error('initial output missing'); process.exit(1); }
