...
const w=dom.window;
if(!w.WordScrambleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('猜原词')<0){ console.error('initial output missing'); process.exit(1); }
