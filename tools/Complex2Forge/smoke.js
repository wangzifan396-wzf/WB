...
const w=dom.window;
if(!w.Complex2ForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('复数运算')<0){ console.error('initial output missing'); process.exit(1); }
