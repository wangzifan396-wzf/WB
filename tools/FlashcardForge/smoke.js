...
const w=dom.window;
if(!w.FlashcardForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('闪卡复习')<0){ console.error('initial output missing'); process.exit(1); }
