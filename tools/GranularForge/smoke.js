...
const w=dom.window;
if(!w.GranularForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('GranularForge')<0){ console.error('initial output missing'); process.exit(1); }
