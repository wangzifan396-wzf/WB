...
const w=dom.window;
if(!w.CrossForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('CrossForge')<0){ console.error('initial output missing'); process.exit(1); }
