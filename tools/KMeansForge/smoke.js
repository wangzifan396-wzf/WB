...
const w=dom.window;
if(!w.KMeansForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('KMeansForge')<0){ console.error('initial output missing'); process.exit(1); }
