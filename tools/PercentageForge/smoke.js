...
const w=dom.window;
if(!w.PercentageForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('百分比')<0){ console.error('initial output missing'); process.exit(1); }
