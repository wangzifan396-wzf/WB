...
const w=dom.window;
if(!w.RhymeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('RhymeForge')<0){ console.error('initial output missing'); process.exit(1); }
