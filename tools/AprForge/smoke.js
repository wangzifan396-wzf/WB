...
const w=dom.window;
if(!w.AprForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('名义↔有效利率')<0){ console.error('initial output missing'); process.exit(1); }
