...
const w=dom.window;
if(!w.TTestForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('t 检验')<0){ console.error('initial output missing'); process.exit(1); }
