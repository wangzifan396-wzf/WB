...
const w=dom.window;
if(!w.NernstForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('能斯特方程')<0){ console.error('initial output missing'); process.exit(1); }
