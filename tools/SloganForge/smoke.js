...
const w=dom.window;
if(!w.SloganForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SloganForge')<0){ console.error('initial output missing'); process.exit(1); }
