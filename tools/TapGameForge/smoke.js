...
const w=dom.window;
if(!w.TapGameForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TapGameForge')<0){ console.error('initial output missing'); process.exit(1); }
