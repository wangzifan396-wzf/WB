...
const w=dom.window;
if(!w.UrlParseForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('URL解析')<0){ console.error('initial output missing'); process.exit(1); }
