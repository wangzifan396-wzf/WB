...
const w=dom.window;
if(!w.NonogramForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点击格子切换填充')<0){ console.error('initial output missing'); process.exit(1); }
