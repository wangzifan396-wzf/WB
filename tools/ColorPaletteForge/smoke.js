...
const w=dom.window;
if(!w.ColorPaletteForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('调色板')<0){ console.error('initial output missing'); process.exit(1); }
