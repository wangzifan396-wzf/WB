...
const w=dom.window;
if(!w.GratuityForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('离职补偿金')<0){ console.error('initial output missing'); process.exit(1); }
