...
const w=dom.window;
if(!w.AnionGapForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AnionGapForge')<0){ console.error('initial output missing'); process.exit(1); }
