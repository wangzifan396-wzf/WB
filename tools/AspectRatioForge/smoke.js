...
const w=dom.window;
if(!w.AspectRatioForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('宽高比计算')<0){ console.error('initial output missing'); process.exit(1); }
