...
ok('abc', A.atbash('abc')==='zyx');
ok('inv', A.atbash(A.atbash('Hello World'))==='Hello World');
ok('mixed', A.atbash('AbC')==='ZyX');
console.log('AtbashForge _test: '+pass+' passed, '+fail+' failed'); process.exit(fail?1:0);
