...
const w=dom.window;
if(!w.AcrosticForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('AcrosticForge')<0){ console.error('initial output missing'); process.exit(1); }
