...
const w=dom.window;
if(!w.__EditorconfigForge__){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('EditorconfigForge')<0){ console.error('initial output missing'); process.exit(1); }
