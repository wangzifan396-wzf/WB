...
const w=dom.window;
if(!w.PermutationRankForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('排列序')<0){ console.error('initial output missing'); process.exit(1); }
