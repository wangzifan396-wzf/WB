...
const w=dom.window;
if(!w.PaddingBoxForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('盒模型')<0){ console.error('initial output missing'); process.exit(1); }
