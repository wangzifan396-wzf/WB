...
const w=dom.window;
if(!w.PasswordStrengthForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('密码强度')<0){ console.error('initial output missing'); process.exit(1); }
