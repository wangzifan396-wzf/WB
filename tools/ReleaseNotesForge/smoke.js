...
const w=dom.window;
if(!w.ReleaseNotesForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('ReleaseNotesForge')<0){ console.error('initial output missing'); process.exit(1); }
