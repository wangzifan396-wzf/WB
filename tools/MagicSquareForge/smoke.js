...
const w=dom.window;
if(!w.MagicSquareForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('输入阶数（3-9）后点“生成幻方”')<0){ console.error('initial output missing'); process.exit(1); }
