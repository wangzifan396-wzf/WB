...
const w=dom.window;
if(!w.JsonFormatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('JSON工具')<0){ console.error('initial output missing'); process.exit(1); }
