...
const w=dom.window;
if(!w.SciNotationForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('科学计数法')<0){ console.error('initial output missing'); process.exit(1); }
