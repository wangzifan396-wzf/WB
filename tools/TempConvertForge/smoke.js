...
const w=dom.window;
if(!w.TempConvertForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('TempConvertForge')<0){ console.error('initial output missing'); process.exit(1); }
