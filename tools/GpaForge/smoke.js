...
const w=dom.window;
if(!w.GpaForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('加权 GPA')<0){ console.error('initial output missing'); process.exit(1); }
