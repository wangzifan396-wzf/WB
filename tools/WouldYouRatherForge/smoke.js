...
const w=dom.window;
if(!w.WouldYouRatherForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('二选一')<0){ console.error('initial output missing'); process.exit(1); }
