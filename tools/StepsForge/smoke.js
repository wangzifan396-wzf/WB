...
const w=dom.window;
if(!w.StepsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('StepsForge')<0){ console.error('initial output missing'); process.exit(1); }
