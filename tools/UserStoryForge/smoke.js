...
const w=dom.window;
if(!w.UserStoryForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('UserStoryForge')<0){ console.error('initial output missing'); process.exit(1); }
