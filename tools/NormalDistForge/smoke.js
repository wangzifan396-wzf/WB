...
const w=dom.window;
if(!w.NormalDistForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('正态分布')<0){ console.error('initial output missing'); process.exit(1); }
