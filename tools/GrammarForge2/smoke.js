...
const w=dom.window;
if(!w.GrammarForge2Pure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('语法练习')<0){ console.error('initial output missing'); process.exit(1); }
