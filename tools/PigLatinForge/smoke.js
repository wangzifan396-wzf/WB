...
const w=dom.window;
if(!w.PigLatinForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('PigLatinForge')<0){ console.error('initial output missing'); process.exit(1); }
