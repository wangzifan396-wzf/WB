...
const w=dom.window;
if(!w.OldMaidForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('点“开始”发牌（已自动弃掉所有对子）')<0){ console.error('initial output missing'); process.exit(1); }
