...
const w=dom.window;
if(!w.TriangleForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('三角形求解')<0){ console.error('initial output missing'); process.exit(1); }
