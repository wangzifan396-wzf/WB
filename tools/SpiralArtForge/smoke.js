...
const w=dom.window;
if(!w.SpiralArtForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('SpiralArtForge')<0){ console.error('initial output missing'); process.exit(1); }
