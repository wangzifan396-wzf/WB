...
const w=dom.window;
if(!w.PhotonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('波与光子')<0){ console.error('initial output missing'); process.exit(1); }
