...
const w=dom.window;
if(!w.NavyBodyFatForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('海军法体脂')<0){ console.error('initial output missing'); process.exit(1); }
