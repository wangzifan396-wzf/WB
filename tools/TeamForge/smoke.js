...
const w=dom.window;
if(!w.TeamForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('随机分队')<0){ console.error('initial output missing'); process.exit(1); }
