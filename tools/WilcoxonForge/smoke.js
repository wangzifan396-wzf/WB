...
const w=dom.window;
if(!w.WilcoxonForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('符号秩')<0){ console.error('initial output missing'); process.exit(1); }
