...
const w=dom.window;
if(!w.DateDiffForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('日期计算')<0){ console.error('initial output missing'); process.exit(1); }
