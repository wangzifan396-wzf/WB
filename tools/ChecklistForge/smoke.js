...
const w=dom.window;
if(!w.ChecklistForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('检查清单')<0){ console.error('initial output missing'); process.exit(1); }
