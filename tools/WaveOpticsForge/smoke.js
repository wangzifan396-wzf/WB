...
const w=dom.window;
if(!w.WaveOpticsForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('波动光学')<0){ console.error('initial output missing'); process.exit(1); }
