...
const w=dom.window;
if(!w.TodoForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('本地待办')<0){ console.error('initial output missing'); process.exit(1); }
