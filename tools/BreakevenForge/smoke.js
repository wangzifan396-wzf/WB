...
const w=dom.window;
if(!w.BreakevenForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('BreakevenForge')<0){ console.error('initial output missing'); process.exit(1); }
