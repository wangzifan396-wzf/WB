...
const w=dom.window;
if(!w.StackForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('栈 / RPN 求值')<0){ console.error('initial output missing'); process.exit(1); }
