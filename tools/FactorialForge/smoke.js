...
const w=dom.window;
if(!w.FactorialForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('阶乘')<0){ console.error('initial output missing'); process.exit(1); }
