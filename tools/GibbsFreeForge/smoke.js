...
const w=dom.window;
if(!w.GibbsFreeForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('吉布斯自由能')<0){ console.error('initial output missing'); process.exit(1); }
