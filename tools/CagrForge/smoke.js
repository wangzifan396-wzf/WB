...
const w=dom.window;
if(!w.CagrForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('复合年增长率')<0){ console.error('initial output missing'); process.exit(1); }
