...
const w=dom.window;
if(!w.BlessingForgePure){ console.error('pure missing'); process.exit(1); }
if(w.document.body.innerHTML.indexOf('祝福语')<0){ console.error('initial output missing'); process.exit(1); }
