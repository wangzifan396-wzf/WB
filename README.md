...
| [FullwidthForge](https://wangzifan396-wzf.github.io/WB/tools/FullwidthForge/) | 文本处理 | 全角半角互转：ASCII 与全角区（FF01–FF5E）互转，空格与 U+3000 对应，离线处理。 |
| [ReverseForge](https://wangzifan396-wzf.github.io/WB/tools/ReverseForge/) | 文本处理 | 文本反转：将字符顺序倒序排列，支持整段反转或按行反转（不改变行序），离线处理。 |
| [IndentForge](https://wangzifan396-wzf.github.io/WB/tools/IndentForge/) | 文本处理 | 批量缩进：整块文本统一增加或减少缩进，可选 2/4 空格或制表符与级数，离线处理。 |
| [UriForge](https://wangzifan396-wzf.github.io/WB/tools/UriForge/) | 网络 | URI 解析：拆解 scheme/host/path/query/fragment 与查询参数，并提供编解码，离线处理。 |
| [RadiusForge](https://wangzifan396-wzf.github.io/WB/tools/RadiusForge/) | 设计工具 | 圆角生成：四角半径独立可调，实时预览并输出 CSS border-radius 代码，离线处理。 |
| [SpacingForge](https://wangzifan396-wzf.github.io/WB/tools/SpacingForge/) | 设计工具 | 间距刻度：生成设计系统间距变量（推荐刻度或线性基数×N），输出 CSS 自定义属性，离线处理。 |
| [CornellForge](https://wangzifan396-wzf.github.io/WB/tools/CornellForge/) | 教育工具 | 康奈尔笔记：按主题与线索关键词生成线索栏/笔记栏/总结三段式模板，离线处理。 |
| [NumberGuessForge](https://wangzifan396-wzf.github.io/WB/tools/NumberGuessForge/) | 游戏 | 猜数字：1–100 猜数游戏，给出大小提示与范围收敛，可请求二分提示，离线对局。 |
| [TruncateForge](https://wangzifan396-wzf.github.io/WB/tools/TruncateForge/) | 文本处理 | 文本截断：按字符/词/显示宽度（CJK 计 2 宽）截断并追加可自定义省略号，离线处理。 |
| [DataCleanForge](https://wangzifan396-wzf.github.io/WB/tools/DataCleanForge/) | 文本处理 | 数据清洗：统一换行符/去控制字符/修整行首尾/压缩连续空格/去空行，可组合，离线处理。 |
| [SigFigForge](https://wangzifan396-wzf.github.io/WB/tools/SigFigForge/) | 实用计算 | 有效数字：按位数保留有效数字，指数结果自动展开为普通小数，离线处理。 |
| [RoundingForge](https://wangzifan396-wzf.github.io/WB/tools/RoundingForge/) | 实用计算 | 舍入模式：四舍五入（远离零）/银行家舍入/向下/向上/截断，可指定小数位，离线处理。 |
| [HeaderForge](https://wangzifan396-wzf.github.io/WB/tools/HeaderForge/) | 网络 | HTTP 头：解析为列表、归一化重建，或输出常用头模板，离线处理。 |
...
| [UrlExtractForge](https://wangzifan396-wzf.github.io/WB/tools/UrlExtractForge/) | 文本处理 | URL 提取：从文本抽取链接，自动去除尾部标点，可去重、可去掉查询串，离线处理。 |
| [PhoneExtractForge](https://wangzifan396-wzf.github.io/WB/tools/PhoneExtractForge/) | 文本处理 | 手机号提取：从文本抽取中国大陆手机号，可去重，支持校验与中间四位脱敏，离线处理。 |
| [WorkdayForge](https://wangzifan396-wzf.github.io/WB/tools/WorkdayForge/) | 实用计算 | 工作日计算：统计区间内工作日数（排除周末），可指定节假日，起止自动排序，离线处理。 |
| [PaddingForge](https://wangzifan396-wzf.github.io/WB/tools/PaddingForge/) | 设计工具 | 内外边距：四边独立设置，自动收缩为最简 CSS 简写（1/2/3/4 值），带可视化预览，离线处理。 |
| [CardForge](https://wangzifan396-wzf.github.io/WB/tools/CardForge/) | 设计工具 | 卡片组件：生成卡片 CSS（宽度/圆角/内边距/阴影层级/背景），带实时预览，离线处理。 |
| [SmartGoalForge](https://wangzifan396-wzf.github.io/WB/tools/SmartGoalForge/) | 效率工具 | SMART 目标：生成具体/可衡量/可实现/相关/有时限五要素拆解模板与里程碑占位，离线处理。 |
| [OkrForge](https://wangzifan396-wzf.github.io/WB/tools/OkrForge/) | 效率工具 | OKR 模板：按 Objective 与 Key Results 生成含关键举措、风险依赖的结构化模板，离线处理。 |
| [CheatSheetForge](https://wangzifan396-wzf.github.io/WB/tools/CheatSheetForge/) | 教育工具 | 速查表：将「概念: 说明」条目转为 Markdown 表格，便于整理语法/公式备忘，离线处理。 |
| [ListForge](https://wangzifan396-wzf.github.io/WB/tools/ListForge/) | 文本处理 | 列表处理：自定义分隔符拆分，可去空/去重/排序/加引号并以新分隔符重拼，离线处理。 |
| [MergeForge](https://wangzifan396-wzf.github.io/WB/tools/MergeForge/) | 文本处理 | 双列合并：两列文本按行拼接（zip），长度不等自动补空，连接符可自定义，离线处理。 |
| [PercentChangeForge](https://wangzifan396-wzf.github.io/WB/tools/PercentChangeForge/) | 实用计算 | 百分比变化：计算涨跌变化量与变化率（增长/下降/持平），并支持部分占整体比例，离线处理。 |
| [SpeedForge](https://wangzifan396-wzf.github.io/WB/tools/SpeedForge/) | 实用计算 | 速度计算：距离/时间/速度三项知二求一，自动识别求解项并校验取值，离线处理。 |
| [LayoutForge](https://wangzifan396-wzf.github.io/WB/tools/LayoutForge/) | 设计工具 | 布局生成：5 种常见版式（居中/侧边栏/圣杯/网格/堆叠）CSS 生成 + 实时预览，间距可调，离线处理。 |
| [PaddingBoxForge](https://wangzifan396-wzf.github.io/WB/tools/PaddingBoxForge/) | 设计工具 | 盒模型：按宽高/内边距/边框/外边距计算内容区与总占用尺寸，支持 content-box 与 border-box，带可视化，离线处理。 |
| [QuizGenForge](https://wangzifan396-wzf.github.io/WB/tools/QuizGenForge/) | 教育工具 | 测验生成：从「问题: 答案」条目生成填空题或选择题，干扰项取自其他答案，种子可复现，离线处理。 |
| [DecisionForge](https://wangzifan396-wzf.github.io/WB/tools/DecisionForge/) | 效率工具 | 决策矩阵：按方案 × 准则生成加权评分表，含权重清单与结论区，离线处理。 |
| [FillForge](https://wangzifan396-wzf.github.io/WB/tools/FillForge/) | 文本处理 | 文本对齐：按字符数批量填充到指定宽度，支持左/右/居中对齐与自定义填充字符，离线处理。 |
| [BatteryForge](https://wangzifan396-wzf.github.io/WB/tools/BatteryForge/) | 实用计算 | 续航估算：按电池容量、工作电流与效率估算可用时长（小时/天），并给出 Wh 能量，离线处理。 |
| [BadgeForge](https://wangzifan396-wzf.github.io/WB/tools/BadgeForge/) | 设计工具 | 徽章：生成徽章 CSS（底色/文字色/圆角/内边距/字号）并实时预览，离线处理。 |
| [TooltipForge](https://wangzifan396-wzf.github.io/WB/tools/TooltipForge/) | 设计工具 | 提示气泡：生成纯 CSS 提示气泡（四方位、悬停显示、attr(data-tip) 取文案）并预览，离线处理。 |
| [PriorityForge](https://wangzifan396-wzf.github.io/WB/tools/PriorityForge/) | 效率工具 | 优先级矩阵：按重要/紧急生成艾森豪威尔四象限清单，可预填各象限任务，离线处理。 |
